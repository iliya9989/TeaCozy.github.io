...
var rr = (t, e) => () => (t && (e = t((t = 0))), e);
var Ct = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
  Me = (t, e) => {
    for (var r in e) Ue(t, r, { get: e[r], enumerable: !0 });
  },
  nr = (t, e, r, n) => {
    if ((e && typeof e == "object") || typeof e == "function")
      for (let o of iu(e))
        !au.call(t, o) &&
          ...
          Ue(t, o, {
            get: () => e[o],
            enumerable: !(n = ou(e, o)) || n.enumerable,
          });
    return t;
  };
var ur = (t, e, r) => (
  ...
  Du = (t) => nr(Ue({}, "__esModule", { value: !0 }), t);
var cu = (t, e, r) => {
...
var le = (t, e, r) => (cu(t, e, "access private method"), r);
var ir = Ct((yt) => {
  "use strict";
        ...
        for (var p = -1 * D; p <= D; p += 2) {
          ...
          if (
            (!C || (_ && E.newPos < h.newPos)
              ? ((m = pu(h)), u.pushComponent(m.components, void 0, !0))
              : ((m = E),
                m.newPos++,
            ...
            return i(fu(u, m.components, r, e, u.useLongestToken));
          F[p] = m;
        }
        D++;
      }
...
var cn = {};
Me(cn, { getChalk: () => Ju, shouldHighlight: () => qu });
var qu,
  Ju,
  ln = rr(() => {
    Pe();
...
var Fn = Ct((pt) => {
  ...
  function dn(t, e, r = {}) {
    let n = (r.highlightCode || r.forceColor) && (0, Yt.shouldHighlight)(r),
      o = (0, Yt.getChalk)(r),
      u = Xu(o),
      i = (p, m) => (n ? p(m) : m),
      s = t.split(pn),
      { start: a, end: D, markerLines: c } = Zu(e, s, r),
      F = e.start && typeof e.start.column == "number",
      f = String(D).length,
      l = (n ? (0, Yt.default)(t, r) : t)
        .split(pn, D)
        .slice(a, D)
        .map((p, m) => {
          let E = a + 1 + m,
          ...
          if (C) {
            let ee = "";
            if (Array.isArray(C)) {
              let M = p.slice(0, Math.max(C[0] - 1, 0)).replace(/[^\t]/g, " "),
                te = C[1] || 1;
              (ee = [
                `
 `,
                ...
                " ",
                M,
                i(u.marker, "^").repeat(te),
              ].join("")),
                _ && r.message && (ee += " " + i(u.message, r.message));
            }
            return [
              i(u.marker, ">"),
              i(u.gutter, g),
...
${l}`),
  ...
  function Qu(t, e, r, n = {}) {
    ...
    return (r = Math.max(r, 0)), dn(t, { start: { column: r, line: e } }, n);
  }
});
var er = {};
Me(er, {
...
var W = "string",
  ...
  O = "label",
  b = "break-parent",
  We = new Set([z, S, v, P, A, k, B, L, I, R, x, O, b]);
function Eu(t) {
  if (typeof t == "string") return W;
...
var G = Eu;
var hu = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function Cu(t) {
  let e = t === null ? "null" : typeof t;
  if (e !== "string" && e !== "object")
    return `Unexpected doc '${e}', 
Expected it to be 'string' or 'object'.`;
  if (G(t)) throw new Error("doc is valid.");
...
var Dr = () => {},
  ...
  ze = Dr;
function ae(t) {
  return K(t), { type: S, contents: t };
}
function se(t, e) {
  return K(e), { type: v, contents: e, n: t };
}
function _t(t, e = {}) {
  return (
    K(t),
...
function cr(t) {
  return se(Number.NEGATIVE_INFINITY, t);
}
function lr(t) {
  return se({ type: "root" }, t);
}
function fr(t) {
  return se(-1, t);
}
function pr(t, e) {
  return _t(t[0], { ...e, expandedStates: t });
}
function Ge(t) {
...
function Fr(t, e) {
  return K(t), { type: L, contents: t, groupId: e.groupId, negate: e.negate };
}
function _e(t) {
  return K(t), { type: I, contents: t };
}
var mr = { type: R },
  fe = { type: b },
  Er = { type: P },
  Ae = { type: x, hard: !0 },
  At = { type: x, hard: !0, literal: !0 },
  Ke = { type: x },
  hr = { type: x, soft: !0 },
  H = [Ae, fe],
  He = [At, fe],
...
function qe(t, e, r) {
  ...
  let n = t;
  if (e > 0) {
    for (let o = 0; o < Math.floor(e / r); ++o) n = ae(n);
    (n = se(e % r, n)), (n = se(Number.NEGATIVE_INFINITY, n));
  }
  return n;
}
function Cr(t, e) {
  return K(e), t ? { type: O, label: t, contents: e } : e;
}
var yu = (t, e, r) => {
    if (!(t && e == null))
...
function _u(t) {
  if (!t) return 0;
  if (!xu.test(t)) return t.length;
  t = t.replace(xr(), "  ");
  let e = 0;
  for (let r of t) {
    let n = r.codePointAt(0);
    if (n <= 31 || (n >= 127 && n <= 159) || (n >= 768 && n <= 879)) continue;
    let o = _r.eastAsianWidth(r);
    e += o === "F" || o === "W" ? 2 : 1;
  }
  return e;
}
...
function wr(t) {
  let e = new Set(),
    r = [];
  function n(u) {
    if ((u.type === b && Ar(r), u.type === A)) {
      if ((r.push(u), e.has(u))) return !1;
      e.add(u);
    }
  }
  function o(u) {
    u.type === A && r.pop().break && Ar(r);
  }
  xe(t, n, o, !0);
}
function Bu(t) {
...
`,
      ...
      case z:
        ...
        break;
      case S:
        i.push({ ind: Ou(f, e), mode: d, doc: l.contents });
        break;
      case v:
        i.push({ ind: Nu(f, l.n, e), mode: d, doc: l.contents });
        break;
      case P:
        u -= bt(s);
        break;
      case A:
        switch (d) {
          case q:
            if (!a) {
              i.push({ ind: f, mode: l.break ? Y : q, doc: l.contents });
              break;
            }
          case Y: {
            a = !1;
            let p = { ind: f, mode: q, doc: l.contents },
              m = n - u,
              E = D.length > 0;
                ...
                for (let g = 1; g < l.expandedStates.length + 1; g++)
                  if (g >= l.expandedStates.length) {
                    ...
                    let C = l.expandedStates[g],
                      _ = { ind: f, mode: q, doc: C };
                    if (Qe(_, i, m, E, r)) {
                      i.push(_);
                      break;
                    }
                  }
            } else i.push({ ind: f, mode: Y, doc: l.contents });
            break;
          }
        }
      ...
      case k: {
        ...
        if (m.length === 0) break;
        let [E, h] = m,
          g = { ind: f, mode: q, doc: E },
          C = { ind: f, mode: Y, doc: E },
          _ = Qe(g, [], p, D.length > 0, r, !0);
        if (m.length === 1) {
          _ ? i.push(g) : i.push(C);
          break;
        }
        let ee = { ind: f, mode: q, doc: h },
          M = { ind: f, mode: Y, doc: h };
        if (m.length === 2) {
          _ ? i.push(ee, g) : i.push(M, C);
          break;
        }
        m.splice(0, 2);
        let te = { ind: f, mode: d, doc: Ge(m) },
          tr = m[0];
        Qe({ ind: f, mode: q, doc: [E, h, tr] }, [], p, D.length > 0, r, !0)
          ? i.push(te, ee, g)
          : _
          ? i.push(te, M, g)
          : i.push(te, M, C);
...
function Z(t) {
  ...
  return t.type === B
    ? {
        ...t,
        breakContents: Z(t.breakContents),
        flatContents: Z(t.flatContents),
      }
    : t.type === A
    ? {
        ...t,
        contents: Z(t.contents),
        expandedStates: (e = t.expandedStates) == null ? void 0 : e.map(Z),
      }
    : t.type === k
    ? { type: "fill", parts: t.parts.map(Z) }
    : t.contents
    ? { ...t, contents: Z(t.contents) }
    : t;
}
function vr(t) {
  ...
  function n(u, i, s) {
    ...
    if (u.type === I) return "lineSuffix(" + n(u.contents) + ")";
    if (u.type === R) return "lineSuffixBoundary";
    if (u.type === O)
...
function et({ plugins: t = [], showDeprecated: e = !1 } = {}) {
  let r = t.flatMap((o) => o.languages ?? []),
    n = [];
  for (let o of vu(Object.assign({}, ...t.map(({ options: u }) => u), Pr)))
    (!e && o.deprecated) ||
      (Array.isArray(o.choices) &&
        (e || (o.choices = o.choices.filter((u) => !u.deprecated)),
        o.name === "parser" &&
          (o.choices = [...o.choices, ...Su(o.choices, r, t)])),
...
var Pu = (t) => t.split(/[/\\]/).pop();
function Lr(t, e) {
  if (!e) return;
  let r = Pu(e).toLowerCase();
  return t.find((n) => {
    var o, u;
    return (
...
var ne = {
  ...
  value(t) {
    ...
    if (Array.isArray(t)) return `[${t.map((r) => ne.value(r)).join(", ")}]`;
    let e = Object.keys(t);
    return e.length === 0
      ? "{}"
      : `{ ${e.map((r) => `${ne.key(r)}: ${ne.value(t[r])}`).join(", ")} }`;
  },
  pair: ({ key: t, value: e }) => ne.value({ [t]: e }),
};
Pe();
var Rr = (t, e, { descriptor: r }) => {
  let n = [
    `${N.yellow(typeof t == "string" ? r.key(t) : r.pair(t))} is deprecated`,
  ];
  return (
    e &&
      n.push(
        `we now treat it as ${N.blue(
...
var tt = Symbol.for("vnopts.VALUE_NOT_EXIST"),
  Fe = Symbol.for("vnopts.VALUE_UNCHANGED");
var Yr = " ".repeat(2),
  Vr = (t, e, r) => {
    let { text: n, list: o } = r.normalizeExpectedResult(
      ...
      u = [];
    return (
      n && u.push(jr(t, e, n, r.descriptor)),
      o &&
        u.push(
          [jr(t, e, o.title, r.descriptor)].concat(
            o.values.map((i) => $r(i, r.loggerPrintWidth)),
          ).join(`
`),
        ),
      Ur(u, r.loggerPrintWidth)
    );
  };
function jr(t, e, r, n) {
  return [
    `Invalid ${N.red(n.key(t))} value.`,
    `Expected ${N.blue(r)},`,
    `but received ${e === tt ? N.gray("nothing") : N.red(n.value(e))}.`,
  ].join(" ");
}
function $r({ text: t, list: e }, r) {
  let n = [];
  return (
    t && n.push(`- ${N.blue(t)}`),
    e &&
      n.push(
        [`- ${N.blue(e.title)}:`].concat(
          e.values.map((o) => $r(o, r - Yr.length).replace(/^|\n/g, `$&${Yr}`)),
        ).join(`
`),
      ),
    Ur(n, r)
...
function Ot(t, e) {
  ...
  let i,
    ...
    c = 0,
    F = 0;
  for (; c < n; ) (Mr[c] = t.charCodeAt(u + c)), (wt[c] = ++c);
  for (; F < o; )
...
var rt = (t, e, { descriptor: r, logger: n, schemas: o }) => {
  let u = [`Ignored unknown option ${N.yellow(r.pair({ key: t, value: e }))}.`],
    i = Object.keys(o)
      .sort()
      .find((s) => Ot(t, s) < 3);
  i && u.push(`Did you mean ${N.blue(r.key(i))}?`), n.warn(u.join(" "));
};
var Ru = [
  "default",
  "expected",
...
function Yu(t, e) {
  let r = new t(e),
    n = Object.create(r);
  for (let o of Ru) o in e && (n[o] = ju(e[o], r, w.prototype[o].length));
  return n;
}
var w = class {
  static create(e) {
...
var ot = class extends w {
  ...
  redirect(e, r) {
    ...
    for (let u of e) {
      ...
      "remain" in i && n.push(i.remain), o.push(...i.redirect.map(Wr));
    }
...
function Tt(t) {
  ...
  return (
    ...
    r
      ? { text: e, list: { title: r.title, values: r.values.map(Tt) } }
      : { text: e }
  );
}
function St(t, e) {
...
var ct = class extends Dt {
  ...
  validate(e, r) {
    return r.normalizeValidateResult(super.validate(e, r), e) === !0 && Jr(e);
  }
};
...
var lt = class {
  constructor(e, r) {
    ...
    (this._utils = {
      ...
      loggerPrintWidth: o,
      schemas: Gr(e, "name"),
      normalizeDefaultResult: Nt,
      normalizeExpectedResult: Tt,
      normalizeDeprecatedResult: vt,
      normalizeForwardResult: st,
      normalizeRedirectResult: Pt,
      normalizeValidateResult: St,
    }),
      (this._unknownHandler = i),
      (this._invalidHandler = Zr(s)),
  ...
  normalize(e) {
    ...
    for (let i of Object.keys(this._utils.schemas)) {
      ...
      if (!(i in r)) {
        let a = Nt(s.default(this._utils));
    ...
    for (let i of Object.keys(this._utils.schemas)) {
      ...
      D !== Fe && (this._applyValidation(D, i, s), (r[i] = D));
    }
    ...
    for (let i of o) {
      ...
      let D = ({ from: d, to: l }) => {
        ...
        c = ({ value: d, redirectTo: l }) => {
          let p = vt(s.deprecated(d, this._utils), a, !0);
          if (p !== !1)
            if (p === !0)
      ...
      let f = Pt(s.redirect(a, this._utils), a);
  ...
  _applyValidation(e, r, n) {
    let o = St(n.validate(e, this._utils), e);
...
function Uu(
  ...
  let s = o
    ...
    a = Mu(e, { isCLI: n, FlagSchema: u }),
    D = new lt(a, { logger: r, unknown: s, descriptor: i }),
    c = r !== !1;
  c && Lt && (D._hasDeprecationWarned = Lt);
  let F = D.normalize(t);
  return c && (Lt = D._hasDeprecationWarned), F;
}
function Mu(t, { isCLI: e, FlagSchema: r }) {
  let n = [];
  e && n.push(ut.create({ name: "_" }));
  for (let o of t)
    n.push(Wu(o, { isCLI: e, optionInfos: t, FlagSchema: r })),
      o.alias && e && n.push(nt.create({ name: o.alias, sourceName: o.name }));
  return n;
}
function Wu(t, { isCLI: e, optionInfos: r, FlagSchema: n }) {
  let { name: o } = t,
    u = { name: o },
    i,
    s = {};
...
async function zu(t, e = {}) {
  ...
  if (!r.parser)
    if (r.filepath) {
      if (((r.parser = Ir(r, { physicalFile: r.filepath })), !r.parser))
  ...
  return (
    ...
    nn(r, n, { passThrough: Object.keys(sn), ...e })
  );
}
var ue = zu;
var an = new Set([
  ...
  Gu = (t) => Object.keys(t).filter((e) => !an.has(e));
function Ku(t) {
  return t ? (e) => t(e, an) : Gu;
}
var J = Ku;
function Hu(t, e) {
  let {
...
function to(t, e) {
  let { loc: r } = t;
  if (r) {
    let n = (0, mn.codeFrameColumns)(e, r, { highlightCode: !0 });
    throw (
      ((t.message +=
        `
` + n),
...
var Ie,
  ...
  jt = class {
    ...
    get ancestors() {
      return [...le(this, me, dt).call(this)];
    }
    getName() {
      let { stack: e } = this,
        { length: r } = e;
    ...
    getNode(e = 0) {
      let r = le(this, Ie, Vt).call(this, e);
    ...
    callParent(e, r = 0) {
      let n = le(this, Ie, Vt).call(this, r + 1),
    ...
    findAncestor(e) {
      for (let r of le(this, me, dt).call(this)) if (e(r)) return r;
    }
    hasAncestor(e) {
      for (let r of le(this, me, dt).call(this)) if (e(r)) return !0;
      return !1;
    }
  };
(Ie = new WeakSet()),
...
function* gn(t, e) {
  ...
  for (let n = 0; n < r.length; n++) {
    let o = r[n];
    for (let u of Ut(o, e)) yield u, r.push(u);
  }
}
function io(t) {
...
function Et(t, e) {
  ...
  if (!n) return [];
  let s = (
    (r == null ? void 0 : r(t, e)) ?? [...Ut(t, { getVisitorKeys: J(o) })]
  ).flatMap((a) => (n(a) ? [a] : Et(a, e)));
  return s.sort((a, D) => u(a) - u(D) || i(a) - i(D)), Wt.set(t, s), s;
}
function xn(t, e, r, n) {
  ...
  if ((n == null ? void 0 : n.type) === "TemplateLiteral") {
    let { quasis: d } = n,
      l = Gt(d, e, r);
    D && Gt(d, D, r) !== l && (D = null), c && Gt(d, c, r) !== l && (c = null);
  }
...
function _n(t, e) {
  let { comments: r } = t;
  if ((delete t.comments, !$t(r) || !e.printer.canAttachComment)) return;
  let n = [],
    {
      locStart: o,
      locEnd: u,
    ...
    { ownLine: D = zt, endOfLine: c = zt, remaining: F = zt } = s,
    f = r.map((d, l) => ({
      ...xn(t, d, e),
      comment: d,
      text: a,
  ...
  for (let [d, l] of f.entries()) {
    ...
    if (
      ...
      (p.placement = "ownLine"),
        D(...M) || (h ? oe(h, p) : m ? ie(m, p) : E ? Q(E, p) : Q(_, p));
    else if (ao(g, C, f, d))
      (p.placement = "endOfLine"),
        c(...M) || (m ? ie(m, p) : h ? oe(h, p) : E ? Q(E, p) : Q(_, p));
    else if (((p.placement = "remaining"), !F(...M)))
      if (m && h) {
        let te = n.length;
        te > 0 && n[te - 1].followingNode !== h && yn(n, C), n.push(l);
      } else m ? ie(m, p) : h ? oe(h, p) : E ? Q(E, p) : Q(_, p);
  }
  if ((yn(n, e), !i))
    for (let d of r)
...
function so(t, e, r, n) {
  ...
  if (u)
    for (let D = n - 1; D >= 0; D--) {
      ...
      if (F !== u || !An(t.slice(s(c), a))) break;
      a = i(c);
    }
  return U(t, a, { backwards: !0 });
}
function ao(t, e, r, n) {
...
function yn(t, e) {
  ...
  for (i = r; i > 0; --i) {
    ...
    Ye.strictEqual(c, n), Ye.strictEqual(F, o);
  ...
  for (let [D, { comment: c }] of t.entries()) D < i ? ie(n, c) : oe(o, c);
  for (let D of [n, o])
    D.comments &&
      D.comments.length > 1 &&
...
function co(t, e) {
  ...
  if ((c = o.isBlockComment) == null ? void 0 : c.call(o, r)) {
    let F = U(u, s(r)) ? (U(u, i(r), { backwards: !0 }) ? H : Ke) : " ";
    n.push(F);
  } else n.push(H);
  let D = V(u, T(u, s(r)));
  return D !== !1 && U(u, D) && n.push(H), n;
}
function lo(t, e, r) {
  var D;
  let n = t.node,
  ...
  if (
    ...
    let c = je(i, s(n));
    return { doc: _e([H, c ? H : "", o]), isBlock: a, hasLineSuffix: !0 };
  }
  return !a || (r != null && r.hasLineSuffix)
    ? { doc: [_e([" ", o]), fe], isBlock: a, hasLineSuffix: !0 }
...
function fo(t, e) {
  ...
  return (
    t.each(() => {
      ...
      D ? u.push(co(t, e)) : c && ((s = lo(t, e, s)), i.push(s.doc));
    }, "comments"),
    { leading: u, trailing: i }
  );
}
function kn(t, e, r) {
  let { leading: n, trailing: o } = fo(t, r);
...
function ho(t, e) {
  ...
  return r.find((o) => Pn.has(o.type) && n.has(o));
}
function Sn(t) {
  let e = t.length - 1;
  for (;;) {
...
function Co(t, e, { locStart: r, locEnd: n }) {
  let o = t.node,
    u = e.node;
  if (o === u) return { startNode: o, endNode: u };
  let i = r(t.node);
  for (let a of Sn(e.parentNodes))
    if (r(a) >= i) u = a;
    else break;
  let s = n(e.node);
  for (let a of Sn(t.parentNodes)) {
    if (n(a) <= s) o = a;
    else break;
    if (o === u) break;
  }
...
function vn(t, e, r) {
  ...
  switch (t.parser) {
    ...
    case "meriyah":
    case "__babel_estree":
      return go(e.type, r == null ? void 0 : r.type);
    case "json":
    case "json5":
    case "json-stringify":
      return Pn.has(e.type);
    case "graphql":
      return yo.has(e.kind);
    case "vue":
      return e.tag !== "root";
  }
  return !1;
...
function Ln(t, e, r) {
  ...
  let D = Ht(r, n, e, (d, l) => vn(e, d, l), [], "rangeStart"),
    c = a ? D : Ht(r, o, e, (d) => vn(e, d), [], "rangeEnd");
  if (!D || !c) return { rangeStart: 0, rangeEnd: 0 };
  let F, f;
  if (Eo(e)) {
    let d = ho(D, c);
    (F = d), (f = d);
  } else ({ startNode: F, endNode: f } = Co(D, c, e));
  return { rangeStart: Math.min(u(F), u(f)), rangeEnd: Math.max(i(F), i(f)) };
}
function xo(t, e) {
  let { cursorOffset: r, locStart: n, locEnd: o } = e,
    u = J(e.printer.getVisitorKeys),
    i = (a) => n(a) <= r && o(a) >= r,
    s = t;
  for (let a of gn(t, { getVisitorKeys: u, filter: i })) s = a;
  return s;
}
var In = xo;
var $n = "\uFEFF",
  Rn = Symbol("cursor");
async function Un(t, e, r = 0) {
  if (!t || t.trim().length === 0)
    return { formatted: "", cursorOffset: -1, comments: [] };
  let { ast: n, text: o } = await De(t, e);
  e.cursorOffset >= 0 && (e.cursorNode = In(n, e));
  let u = await Ve(n, e, r);
  r > 0 && (u = qe([H, u], r, e.tabWidth));
  let i = pe(u, e);
  if (r > 0) {
  ...
  if (e.cursorOffset >= 0) {
    ...
    d.splice(c, 0, Rn);
    let l = f.split(""),
      p = (0, Vn.diffArrays)(d, l),
      m = F;
    for (let E of p)
      if (E.removed) {
        if (E.value.includes(Rn)) break;
      } else m += E.count;
...
async function _o(t, e) {
  let { ast: r, text: n } = await De(t, e),
    { rangeStart: o, rangeEnd: u } = Ln(n, e, r),
    i = n.slice(o, u),
    s = Math.min(
      o,
      n.lastIndexOf(
...
function Mn(t, e) {
  let { cursorOffset: r, rangeStart: n, rangeEnd: o, endOfLine: u } = Yn(t, e),
    i = t.charAt(0) === $n;
  if (
    (i && ((t = t.slice(1)), r--, n--, o--),
    u === "auto" && (u = gr(t)),
...
async function Jt(t, e) {
  let { hasBOM: r, text: n, options: o } = Mn(t, await ue(e));
  if (
    (o.rangeStart >= o.rangeEnd && n !== "") ||
    (o.requirePragma && !(await jn(n, o)))
  )
  ...
  return (
    o.rangeStart > 0 || o.rangeEnd < n.length
      ...
      : (!o.requirePragma &&
        ...
        (u = await Un(n, o))),
    r &&
      ((u.formatted = $n + u.formatted),
      u.cursorOffset >= 0 && u.cursorOffset++),
    u
  );
}
async function Wn(t, e, r) {
  let { text: n, options: o } = Mn(t, await ue(e)),
    u = await De(n, o);
  return (
    r &&
      (r.preprocessForPrint && (u.ast = await Kt(u.ast, o)),
      r.massage && (u.ast = Dn(u.ast, o))),
    u
  );
}
...
async function Gn(t, e) {
  let r = vr(t),
    { formatted: n } = await Jt(r, { ...e, parser: "__js_expression" });
  return n;
}
async function Kn(t, e) {
  e = await ue(e);
  let { ast: r } = await De(t, e);
  return Ve(r, e);
}
async function Hn(t, e) {
  return pe(t, await ue(e));
}
var Zt = {};
Me(Zt, {
  addDanglingComment: () => Q,
  addLeadingComment: () => oe,
  addTrailingComment: () => ie,
  getAlignmentSize: () => de,
  getIndentSize: () => Jn,
  getMaxContinuousCount: () => qn,
  getNextNonSpaceNonCommentCharacter: () => Qn,
  getNextNonSpaceNonCommentCharacterIndex: () => Io,
  getStringWidth: () => we,
  hasNewline: () => U,
  hasNewlineInRange: () => Xn,
  hasSpaces: () => Zn,
  isNextLineEmpty: () => Vo,
  isNextLineEmptyAfterIndex: () => ht,
  isPreviousLineEmpty: () => Yo,
  makeString: () => eu,
  skip: () => Ee,
  skipEverythingButNewLine: () => mt,
  skipInlineComment: () => he,
  skipNewline: () => V,
  skipSpaces: () => T,
  skipToLineEnd: () => Ft,
...
function bo(t, e) {
  let r = null,
    n = e;
  for (; n !== r; )
    (r = n), (n = T(t, n)), (n = he(t, n)), (n = Ce(t, n)), (n = V(t, n));
  return n;
}
var $e = bo;
function wo(t, e) {
  let r = null,
    n = e;
  for (; n !== r; ) (r = n), (n = Ft(t, n)), (n = he(t, n)), (n = T(t, n));
  return (n = Ce(t, n)), (n = V(t, n)), n !== !1 && U(t, n);
}
var ht = wo;
function Xt(t) {
...
function Oo(t, e) {
  let r = t.match(new RegExp(`(${Xt(e)})+`, "g"));
  return r === null
    ? 0
...
function No(t, e) {
  let r = t.lastIndexOf(`
`);
  return r === -1 ? 0 : de(t.slice(r + 1).match(/^[\t ]*/)[0], e);
}
var Jn = No;
function To(t, e, r) {
  for (let n = e; n < r; ++n)
...
var Xn = To;
function So(t, e, r = {}) {
  return T(t, r.backwards ? e - 1 : e, r) !== e;
}
var Zn = So;
function vo(t, e) {
  let r = $e(t, e);
...
var Qt = {};
Me(Qt, { builders: () => $o, printer: () => Uo, utils: () => Mo });
var $o = {
    join: ke,
    line: Ke,
    softline: hr,
    ...
    literallineWithoutBreakParent: At,
    label: Cr,
    concat: (t) => t,
  },
  Uo = { printDocToString: pe },
  Mo = {
    willBreak: br,
    traverseDoc: xe,
    findInDoc: Je,
...
async function nu(t, e) {
  let { formatted: r } = await ru(t, { ...e, cursorOffset: -1 });
  return r;
}
async function Wo(t, e) {
  return (await nu(t, e)) === t;
}
var zo = ce(et, 0),
  Go = {
    parse: ce(Wn),
