(function (t) {
  ...
  var nr = (t, e, r) => (
    ...
    ur = (t) => rr(Ue({}, "__esModule", { value: !0 }), t);
  var Du = (t, e, r) => {
  ...
  var le = (t, e, r) => (Du(t, e, "access private method"), r);
  var ir = Ct((yt) => {
    "use strict";
          ...
          for (var p = -1 * D; p <= D; p += 2) {
            ...
            if (
              (!C || (_ && E.newPos < h.newPos)
                ? ((m = fu(h)), u.pushComponent(m.components, void 0, !0))
                : ((m = E),
                  m.newPos++,
              ...
              return i(lu(u, m.components, r, e, u.useLongestToken));
            F[p] = m;
          }
          D++;
        }
  ...
  var cn = {};
  Me(cn, { getChalk: () => qu, shouldHighlight: () => Hu });
  var Hu,
    qu,
    ln = tr(() => {
      Pe();
  ...
  var Fn = Ct((pt) => {
    ...
    function dn(t, e, r = {}) {
      let n = (r.highlightCode || r.forceColor) && (0, Yt.shouldHighlight)(r),
        ...
        i = (p, m) => (n ? p(m) : m),
        s = t.split(pn),
        { start: a, end: D, markerLines: c } = Xu(e, s, r),
...
`,
        ...
        case z:
          ...
          break;
        case S:
          i.push({ ind: wu(f, e), mode: d, doc: l.contents });
          break;
        case v:
          i.push({ ind: Ou(f, l.n, e), mode: d, doc: l.contents });
          break;
        case P:
          u -= bt(s);
          break;
        ...
        case k: {
          ...
          let te = { ind: f, mode: d, doc: Ge(m) },
            er = m[0];
          Qe({ ind: f, mode: q, doc: [E, h, er] }, [], p, D.length > 0, r, !0)
            ? i.push(te, ee, g)
            : _
            ? i.push(te, M, g)
            : i.push(te, M, C);
...
in order for it to be formatted.`,
  ...
  function et({ plugins: t = [], showDeprecated: e = !1 } = {}) {
    let r = t.flatMap((o) => o.languages ?? []),
      n = [];
    for (let o of Su(Object.assign({}, ...t.map(({ options: u }) => u), Pr)))
      (!e && o.deprecated) ||
        (Array.isArray(o.choices) &&
          (e || (o.choices = o.choices.filter((u) => !u.deprecated)),
          o.name === "parser" &&
            (o.choices = [...o.choices, ...Tu(o.choices, r, t)])),
  ...
  var vu = (t) => t.split(/[/\\]/).pop();
  function Lr(t, e) {
    if (!e) return;
    let r = vu(e).toLowerCase();
    return t.find((n) => {
      var o, u;
      return (
...
`,
  ...
  var rt = (t, e, { descriptor: r, logger: n, schemas: o }) => {
    let u = [
        `Ignored unknown option ${N.yellow(r.pair({ key: t, value: e }))}.`,
      ],
      i = Object.keys(o)
        .sort()
        .find((s) => Ot(t, s) < 3);
  ...
  function Ru(t, e) {
    let r = new t(e),
      n = Object.create(r);
    for (let o of Iu) o in e && (n[o] = Yu(e[o], r, w.prototype[o].length));
    return n;
  }
  var w = class {
    static create(e) {
  ...
  function Uu(t, { isCLI: e, FlagSchema: r }) {
    let n = [];
    e && n.push(ut.create({ name: "_" }));
    for (let o of t)
      n.push(Mu(o, { isCLI: e, optionInfos: t, FlagSchema: r })),
        o.alias &&
          e &&
          n.push(nt.create({ name: o.alias, sourceName: o.name }));
    return n;
  }
  function Mu(t, { isCLI: e, optionInfos: r, FlagSchema: n }) {
    let { name: o } = t,
      u = { name: o },
      i,
      s = {};
  ...
  var an = new Set([
    ...
    zu = (t) => Object.keys(t).filter((e) => !an.has(e));
  function Gu(t) {
    return t ? (e) => t(e, an) : zu;
  }
  var J = Gu;
  function Ku(t, e) {
    let {
...
` ||
  ...
  function lo(t, e) {
    ...
    return (
      t.each(() => {
        ...
        D ? u.push(Do(t, e)) : c && ((s = co(t, e, s)), i.push(s.doc));
      }, "comments"),
      { leading: u, trailing: i }
    );
  }
  function kn(t, e, r) {
    let { leading: n, trailing: o } = lo(t, r);
  ...
  function ho(t, e, { locStart: r, locEnd: n }) {
    let o = t.node,
      u = e.node;
  ...
  function vn(t, e, r) {
    ...
    switch (t.parser) {
      ...
      case "meriyah":
      case "__babel_estree":
        return Co(e.type, r == null ? void 0 : r.type);
      case "json":
      case "json5":
      case "json-stringify":
        return Pn.has(e.type);
      case "graphql":
        return go.has(e.kind);
      case "vue":
        return e.tag !== "root";
    }
    return !1;
  ...
  function Ln(t, e, r) {
    ...
    if (mo(e)) {
      let d = Eo(D, c);
      (F = d), (f = d);
    } else ({ startNode: F, endNode: f } = ho(D, c, e));
...
`
  ...
  var Qt = {};
  Me(Qt, { builders: () => Vo, printer: () => $o, utils: () => Uo });
  var Vo = {
      join: ke,
      line: Ke,
      softline: hr,
