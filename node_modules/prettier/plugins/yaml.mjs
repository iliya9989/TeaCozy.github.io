    ...
    return (
      typeof t == "string"
        ...
        : (Array.isArray(t) && (t = t[0]),
          t &&
            t.context &&
            (t.lineStarts || (t.lineStarts = Ms(t.context.src)),
            (e = t.lineStarts),
            (n = t.context.src))),
      { lineStarts: e, src: n }
    );
...
` &&
              ...
              if (r[l] === "#") break;
              if (!this.error) {
                let y = `Block scalars must not be less indented than their ${
                  s ? "explicit indentation indicator" : "first line"
                }`;
        ...
        let y = !1,
          ...
          g = this.items.reduce((C, L, M) => {
            ...
            L &&
              ...
              L.commentBefore &&
                L.commentBefore.match(/^.*$/gm).forEach((Oi) => {
                  C.push({ type: "comment", str: `#${Oi}` });
                }),
...
` && (A = ""),
  ...
  var mt = class extends W {
    ...
    Io = { defaultType: p.Type.BLOCK_LITERAL, lineWidth: 76 },
...
`),
    ...
    return (a = c ? a + i.slice(c) : i), n ? a : Vt(a, o, qt, qn(e));
  }
  function Bs(t, e) {
    if (e.implicitKey) {
...
${n}`,
        ...
        "'";
    return e.implicitKey ? r : Vt(r, n, Ys, qn(e));
  }
    ...
    let o = r.indent || (r.forceBlockIndent || Wt(n) ? "  " : ""),
      ...
      c =
        e === p.Type.BLOCK_FOLDED
          ...
          ? !0
          : !Ro(n, be.fold.lineWidth, o.length),
      l = c ? "|" : ">";
    if (!n)
      return (
        l +
...
`) !== -1)
  ...
  function Bo({ format: t, minFractionDigits: e, tag: n, value: r }) {
...
` + s)
  ...
  function me(t, e) {
    ...
    let { comments: n, hasAnchor: r, hasTag: s } = Vo(t.errors, e);
    if (r) {
      let { anchors: o } = t,
        a = e.anchor,
        c = o.getNode(a);
...
${a}`
  ...
  function jo(t, e) {
    ...
    for (let o = 0; o < r.length; ++o) {
      let { key: a } = r[o];
      if ((a instanceof W && (i = !0), t.schema.merge && a && a.value === Ds)) {
        r[o] = new Kt(r[o]);
  ...
  var Qo = ({ context: { lineStart: t, node: e, src: n }, props: r }) => {
...
var Hn = ee((ii) => {
  ...
  var Hs = {
    ...
    da = Jn.concat([Hs, Xs, zs, Zs, ei, ti, ni, ri]),
  ...
  var ya = Jn.concat(
    ...
    Ea = { core: da, failsafe: Jn, json: si, yaml11: ya },
    Sa = {
      binary: D.binary,
      bool: Xs,
      float: ri,
  ...
  var Oa = (t, e) => (t.key < e.key ? -1 : t.key > e.key ? 1 : 0),
    dt = class t {
      constructor({
        ...
        (this.merge = !!n),
          (this.name = r),
          (this.sortMapEntries = s === !0 ? Oa : s || null),
          !e && i && D.warnOptionDeprecation("tags", "customTags"),
          (this.tags = Na(Ea, Sa, e || i, r));
      }
      createNode(e, n, r, s) {
        let i = {
...
var li = ee((en) => {
  ...
  function Ca(t, e, { anchors: n, doc: r }) {
    let s = [],
      i = r.anchors.getName(t);
    return (
      i && ((n[i] = t), s.push(`&${i}`)),
      t.tag ? s.push(ai(r, t.tag)) : e.default || s.push(ai(r, e.tag)),
      s.join(" ")
    );
  }
  function Xt(t, e, n, r) {
...
`) || null;
  ...
  function Ia(t, e) {
    ...
    if (!ci[n]) {
      let s = `Document will be parsed as YAML ${
        t.version || t.options.version
      } rather than YAML ${n}`;
...
`) || null;
  ...
  var Zt = class t {
    ...
    listNonDefaultTags() {
      return Ma(this.contents).filter(
        (e) => e.indexOf(oi.Schema.defaultPrefix) !== 0,
      );
    }
    setTagPrefix(e, n) {
      if (e[0] !== "!" || e[e.length - 1] !== "!")
...
var pi = ee((ui) => {
  ...
  function Ba(t, e) {
    let n = fi(t, e);
    if ((n.warnings.forEach((r) => Ra.warn(r)), n.errors.length > 0))
      throw n.errors[0];
    return n.toJSON();
  }
  function $a(t, e) {
...
var et = Ii;
var Pi = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function _i(t) {
...
var bt = { type: Me };
var xi = { type: te, hard: !0 },
  Ri = { type: te, hard: !0, literal: !0 },
  ne = { type: te },
  Nt = { type: te, soft: !0 },
  N = [xi, bt],
  rt = [Ri, bt];
...
function gr(t, e) {
  ...
  if (
    n.type === "root" &&
    e.filepath &&
    /(?:[/\\]|^)\.(?:prettier|stylelint|lintstaged)rc$/.test(e.filepath)
  )
    return async (r) => {
...
function un(t, e, n) {
  return e(
    "children" in t
      ? { ...t, children: t.children.map((r) => un(r, e, t)) }
      : t,
    n,
  );
}
...
function Sr(t) {
  ...
  if (e.type === "documentBody") {
    let n = t.parent.head;
    return R(n) && yr(x(!1, n.endComments, -1));
  }
  return Z(e) && yr(x(!1, e.leadingComments, -1));
}
function _e(t) {
  return !Ie(t.children) && !qi(t);
}
function qi(t) {
  return Z(t) || ie(t) || pn(t) || H(t) || R(t);
}
function Z(t) {
...
function Nr(t, { parentIndent: e, isLastDescendant: n, options: r }) {
  let s =
...
function Tt(t, e) {
  ...
  return (
    ...
    (s.add(n.position.end.line), Er(n, e) && !gn(t.parent))
      ? Nt
      : ""
  );
}
...
function Gi(t, e, n) {
  ...
  (s.type === "mapping" && H(i.content) && st(o.content)) ||
...
function zi(t, e, n) {
  ...
  r.indent !== null && o.push(r.indent.toString()),
    ...
    pn(r) && o.push(" ", e("indicatorComment"));
  let a = Nr(r, { parentIndent: s, isLastDescendant: i, options: n }),
    c = [];
...
function no(t, e) {
  let n = t.node;
  if (
    (t.isFirst && /---(?:\s|$)/.test(e.originalText.slice(ve(n), ve(n) + 4))) ||
...
function ro(t, e) {
  if (G(e))
    switch ((delete e.position, e.type)) {
      case "comment":
...
function vt(t, e) {
  ...
  return Fr(a, l, yn[n.chomping], o ? n.blockIndent : null, n.strValue, c);
}
function Vr(t, e) {
  return $r(vt(t, e));
}
...
function co(t, e, n) {
  ...
  if (i.length > 1)
    throw new Error(
      `Unexpected multiple document trailing comments at ${ge(
        i[1].position.start,
      )}`,
    );
  if (o.length > 1)
    throw new Error(
      `Unexpected multiple documentHead trailing comments at ${ge(
        o[1].position.start,
      )}`,
    );
  return {
...
function es(t, e) {
  let n = t.cstNode,
    { directives: r, comments: s, endComments: i } = fo(n, e),
    { position: o, endMarkerPoint: a } = uo(n, r, e);
  return (
    e.comments.push(...s, ...i),
    {
      createDocumentHeadWithTrailingComment: (l) => (
        l && e.comments.push(l), Zr(o, r, i, l)
      ),
...
function Cs(t) {
  if (!t.setOrigRanges()) {
    let e = (n) => {
      if (mo(n)) return (n.origStart = n.start), (n.origEnd = n.end), !0;
      if (ho(n)) return (n.origOffset = n.offset), !0;
    };
    t.forEach((n) => bn(n, e));
  }
}
...
function Ln(t) {
  ...
  let n = On(t.position, go, yo, wo),
    r = On(t.position, Eo, So, bo);
  "endComments" in t &&
...
var di = rr(hi(), 1);
var J = rr(gi(), 1),
  _m = J.default.findPair,
  xm = J.default.toJSON,
  Rm = J.default.parseMap,
  Dm = J.default.parseSeq,
  Ym = J.default.stringifyNumber,
  Bm = J.default.stringifyString,
  $m = J.default.Type,
  qa = J.default.YAMLError,
  Fm = J.default.YAMLReferenceError,
  Zn = J.default.YAMLSemanticError,
  Ua = J.default.YAMLSyntaxError,
  qm = J.default.YAMLWarning;
var { Document: yi, parseCST: Ei } = di.default;
function Si(t) {
  let e = Ei(t);
  Cs(e);
  let n = e.map((a) => new yi({ merge: !1, keepCstNodes: !0 }).parse(a)),
    r = new Pr(t),
    s = [],
    i = {
      text: t,
...
function Wa(t) {
  try {
    ...
    throw e != null && e.position
      ? wi(e.message, { loc: e.position, cause: e })
      : e;
  }
}
var ja = {
...
var Qa = {
    bracketSpacing: tn.bracketSpacing,
    singleQuote: tn.singleQuote,
    proseWrap: tn.proseWrap,
  },
  Ni = Qa;
var Ja = { yaml: vr };
var yh = tr;
