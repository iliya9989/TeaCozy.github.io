...
`) &&
  ...
  function B(e, t) {
    let n = 0,
      r = 1;
    for (let i of e.body.matchAll(Vt)) {
...
` + he(this.source, n);
  ...
  function Mt(e, t) {
    ...
    for (; i < r; ) {
      ...
      if (L(s) || s === 45) return jt(e, i, s);
      if (de(s)) return Qt(e, i);
      throw d(
        e.source,
        i,
        s === 39
  ...
  function jt(e, t, n) {
    ...
    if (
      ...
      throw d(
        e.source,
        i,
        `Invalid number, expected digit but got: ${S(e, i)}.`,
      );
  ...
  function me(e, t, n) {
    if (!L(n))
      throw d(
        e.source,
        t,
        `Invalid number, expected digit but got: ${S(e, t)}.`,
      );
    let r = e.source.body,
      i = t + 1;
...
spurious results.`);
  ...
  var an = { bracketSpacing: Ze.bracketSpacing },
    et = an;
  var cn = { graphql: Re };
  return st(un);
});
