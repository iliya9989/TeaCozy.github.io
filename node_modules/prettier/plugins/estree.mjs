...
var Bs = {};
pr(Bs, { languages: () => yl, options: () => sa, printers: () => ml });
var hs = {};
pr(hs, {
  canAttachComment: () => Wo,
  embed: () => Ni,
...
var Cr = Xa;
function Xt(e, t) {
  return t(e) || Gs(e, { getVisitorKeys: Er, predicate: t });
}
function Lt(e) {
  return (
...
var lu = Wn;
var zn = {};
pr(zn, { endOfLine: () => Fo, ownLine: () => Eo, remaining: () => Co });
function lo(e, t) {
  let r = null,
    n = t;
  for (; n !== r; )
  ...
  for (let T = l.length - 2; T >= 0; T--) {
    let N = l[T] === "" && l[T + 1] === "",
      ...
      dn =
        (l[T] === F && l[T + 1] === "" && l[T + 2] === C) ||
        (l[T] === C && l[T + 1] === "" && l[T + 2] === F);
    (Se && h) || N || V || Ee || dn ? l.splice(T, 2) : Be && l.splice(T + 1, 2);
  }
  ...
  function a(L) {
    ...
    k(W) && (Dt(W.callee) || k(W.callee))
      ...
      ? (u.unshift({
          node: W,
          needsParens: we(L, t),
          printed: pe(L, J(W) ? rs(L, t, r) : wr(L, t, r), t),
        }),
  ...
  if (s.length > 1 || s.some((u) => u.length > 0)) {
    ...
    let i = [],
      a = u.map(
        (c) =>
          "${" +
          ms(c, { ...t, printWidth: Number.POSITIVE_INFINITY, endOfLine: "lf" })
            .formatted +
          "}",
      ),
...
function gi(e, t, r, n) {
  ...
  switch (s.type) {
    ...
    case "BindExpression":
      return s.object && i.push(r("object")), i.push(y(E([F, wr(e, t, r)]))), i;
    case "Identifier":
...
var Ss = {};
pr(Ss, { getVisitorKeys: () => ea, massageAstNode: () => ra, print: () => pl });
var al = {
    JsonRoot: ["node"],
    ArrayExpression: ["elements"],
    ObjectExpression: ["properties"],
