(function (n) {
  ...
  var be = (a, u) => () => (
      u || a((u = { exports: {} }).exports, u), u.exports
    ),
    ss = (a, u) => {
      for (var c in u) Re(a, c, { get: u[c], enumerable: !0 });
    },
    Ht = (a, u, c, h) => {
  ...
  var rs = (a, u, c) => (
      ...
      Ht(
        u || !a || !a.__esModule
          ? Re(c, "default", { value: a, enumerable: !0 })
          : c,
        a,
      )
    ),
    as = (a) => Ht(Re({}, "__esModule", { value: !0 }), a);
  var ii = be((se) => {
    "use strict";
...
Defaulting to 2020, but this will stop working in the future.`)),
        ...
        return dt(t.onComment) && (t.onComment = Ti(t, t.onComment)), t;
      }
      function Ti(e, t) {
...
`,
      ...
      (V.prototype.parse = function () {
        ...
        (W.inGenerator.get = function () {
          return (
            (this.currentVarScope().flags & xt) > 0 &&
            !this.currentVarScope().inClassFieldInit
          );
        }),
        (W.inAsync.get = function () {
          return (
            (this.currentVarScope().flags & We) > 0 &&
            !this.currentVarScope().inClassFieldInit
          );
        }),
        (W.canAwait.get = function () {
          for (var e = this.scopeStack.length - 1; e >= 0; e--) {
            ...
            if (t.flags & ne) return (t.flags & We) > 0;
          }
          return (
        ...
        (W.allowSuper.get = function () {
          ...
          return (t & Xe) > 0 || i || this.options.allowSuperOutsideMethod;
        }),
      ...
      (S.isLet = function (e) {
        ...
        (S.parseFunctionStatement = function (e, t, i) {
          return this.next(), this.parseFunction(e, xe | (i ? 0 : $e), !1, t);
        }),
      ...
      (S.parseCatchClauseParam = function () {
        var e = this.parseBindingAtom(),
          t = e.type === "Identifier";
        return (
          this.enterScope(t ? gt : 0),
          this.checkLValPattern(e, t ? St : Q),
        ...
        (S.parseVarId = function (e, t) {
          (e.id = this.parseBindingAtom()),
            this.checkLValPattern(e.id, t === "var" ? Qe : Q, !1);
        });
      var xe = 1,
        $e = 2,
        Ct = 4;
      (S.parseFunction = function (e, t, i, s, n) {
        this.initFunction(e),
          (this.options.ecmaVersion >= 9 ||
            ...
            (this.type === r.star && t & $e && this.unexpected(),
            (e.generator = this.eat(r.star))),
          this.options.ecmaVersion >= 8 && (e.async = !!s),
          t & xe &&
            ((e.id = t & Ct && this.type !== r.name ? null : this.parseIdent()),
            e.id &&
              !(t & $e) &&
        ...
        return (
          ...
          this.enterScope(He(e.async, e.generator)),
        ...
        (S.parseClassStaticBlock = function (e) {
          ...
          var t = this.labels;
          for (
            this.labels = [], this.enterScope(me | Xe);
            this.type !== r.braceR;
        ...
        (S.parseClassId = function (e, t) {
          this.type === r.name
            ? ((e.id = this.parseIdent()),
              t && this.checkLValSimple(e.id, Q, !1))
        ...
        (S.parseExportDefaultDeclaration = function () {
          ...
          if (this.type === r._function || (e = this.isAsyncFunction())) {
            ...
            return (
              this.next(),
              e && this.next(),
              this.parseFunction(t, xe | Ct, !1, e)
            );
      ...
      (q.toAssignable = function (e, t, i) {
        ...
        (q.parseBindingList = function (e, t, i, s) {
          for (var n = [], o = !0; !this.eat(e); )
            if (
              (o ? (o = !1) : this.expect(r.comma), t && this.type === r.comma)
            )
              n.push(null);
            else {
              ...
              this.strict &&
                ...
                s &&
                  ...
                  i &&
                    ...
                    (i[e.name] = !0)),
                  t !== _t && this.declareName(e.name, t, e.start));
              break;
            case "ChainExpression":
              this.raiseRecoverable(
                e.start,
      ...
      (oe.initialContext = function () {
        ...
        (r._function.updateContext = r._class.updateContext =
          function (e) {
            ...
            !(
              (e === r.colon || e === r.braceL) &&
              this.curContext() === I.b_stat
            )
          ...
          if (this.isContextual("await") && this.canAwait)
            ...
            (m.operator = this.value),
              ...
              g
                ...
                : m.operator === "delete" && kt(m.argument)
                ? this.raiseRecoverable(
                    m.start,
      ...
      (C.parseExprSubscripts = function (e, t) {
          ...
          switch (this.type) {
            ...
            case r._false:
              return (
                (s = this.startNode()),
                (s.value =
                  this.type === r._null ? null : this.type === r._true),
        ...
        (C.parseParenAndDistinguishExpression = function (e, t) {
          ...
          if (this.options.preserveParens) {
            ...
            return (
              (pe.expression = n),
              this.finishNode(pe, "ParenthesizedExpression")
            );
          } else return n;
        }),
...
`,
        ...
        (C.parseMethod = function (e, t, i) {
          ...
          return (
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.enterScope(He(t, s.generator) | Xe | (i ? vt : 0)),
            this.expect(r.parenL),
        ...
        (C.parseFunctionBody = function (e, t, i, s) {
          ...
          if (n)
            ...
            (this.labels = []),
              ...
              this.strict && e.id && this.checkLValSimple(e.id, _t),
        ...
        (C.checkParams = function (e, t) {
          for (
            ...
            var o = n[s];
            this.checkLValInnerPattern(o, Qe, t ? null : i);
          }
        }),
      ...
      (ee.enterScope = function (e) {
        ...
        (ee.currentVarScope = function () {
          for (var e = this.scopeStack.length - 1; ; e--) {
            var t = this.scopeStack[e];
            if (t.flags & ze) return t;
          }
        }),
        (ee.currentThisScope = function () {
          for (var e = this.scopeStack.length - 1; ; e--) {
            var t = this.scopeStack[e];
            if (t.flags & ze && !(t.flags & yt)) return t;
          }
        });
      ...
      var wt =
        ...
        Et = wt + " Extended_Pictographic",
        At = Et,
        Pt = At + " EBase EComp EMod EPres ExtPict",
        It = Pt,
        Vi = It,
        Li = { 9: wt, 10: Et, 11: At, 12: Pt, 13: It, 14: Vi },
        Ri =
        ...
        Bi =
          Bt + " Hrkt Katakana_Or_Hiragana Kawi Nag_Mundari Nagm Unknown Zzzz",
        Di = { 9: Vt, 10: Lt, 11: Rt, 12: Ot, 13: Bt, 14: Bi },
        Dt = {};
      function Fi(e) {
        var t = (Dt[e] = {
          binary: $(Li[e] + " " + Nt),
          binaryOfStrings: $(Oi[e]),
          nonBinary: { General_Category: $(Nt), Script: $(Di[e]) },
        });
      ...
      for (var Ze = 0, Ft = [9, 10, 11, 12, 13, 14]; Ze < Ft.length; Ze += 1) {
        var ji = Ft[Ze];
        Fi(ji);
      }
      var v = V.prototype,
        X = function (t) {
          (this.parser = t),
            ...
            (this.unicodeProperties =
              Dt[t.options.ecmaVersion >= 14 ? 14 : t.options.ecmaVersion]),
            (this.source = ""),
            (this.flags = ""),
            (this.start = 0),
            (this.switchU = !1),
      ...
      (v.regexp_eatPatternCharacters = function (e) {
        for (var t = e.pos, i = 0; (i = e.current()) !== -1 && !jt(i); )
          e.advance();
        return e.pos !== t;
      }),
      ...
      (v.regexp_eatAtomEscape = function (e) {
        ...
        (v.regexp_eatControlLetter = function (e) {
          var t = e.current();
          return Mt(t) ? ((e.lastIntValue = t % 32), e.advance(), !0) : !1;
        });
      function Mt(e) {
      ...
      (v.regexp_eatLoneUnicodePropertyNameOrValue = function (e) {
        ...
        (v.regexp_eatClassAtom = function (e) {
          ...
          if (e.eat(92)) {
            ...
            if (e.switchU) {
              var i = e.current();
              (i === 99 || Gt(i)) && e.raise("Invalid class escape"),
                e.raise("Invalid escape");
            }
            e.pos = t;
          }
      ...
      v.regexp_eatFixedHexDigits = function (e, t) {
        ...
        for (var s = 0; s < t; ++s) {
          var n = e.current();
          if (!Kt(n)) return (e.pos = i), !1;
          (e.lastIntValue = 16 * e.lastIntValue + Jt(n)), e.advance();
        }
        return !0;
      };
      var Ve = function (t) {
          ...
          e: for (; this.pos < this.input.length; ) {
            ...
            switch (e) {
              ...
              default:
                if (
                  (e > 8 && e < 14) ||
                  (e >= 5760 && Je.test(String.fromCharCode(e)))
                )
                  ++this.pos;
                else break e;
            }
      ...
      (A.readRadixNumber = function (e) {
        ...
        (A.readNumber = function (e) {
          ...
          if (!i && !e && this.options.ecmaVersion >= 11 && s === 110) {
            var n = Wt(this.input.slice(t, this.pos));
            return (
              ++this.pos,
              F(this.fullCharCodeAtPos()) &&
                this.raise(this.pos, "Identifier directly after number"),
      ...
      if (!u) {
        ...
        (P.jsxTagStart.updateContext = function () {
          ...
          (P.jsxTagEnd.updateContext = function (D) {
            ...
            (G === f && D === c.slash) || G === y
              ? (this.context.pop(),
                (this.exprAllowed = this.curContext() === _))
              : (this.exprAllowed = !0);
          }),
...
`,
            ...
            [ut](h) {
              return (
                h.type === "TemplateElement" &&
                  this[re].templateElements.push(h),
                h.type.includes("Function") &&
                  !h.generator &&
                  (h.generator = !1),
                h
              );
...
`);
  ...
  function M(a) {
    ...
    return De(c) ? Math.min(M(c[0]), u) : u;
  }
  function z(a) {
...
`);
  ...
  function tr(a) {
    ...
    return typeof c != "number"
      ? a
      : Oe(u, { loc: { start: { line: c, column: h } }, cause: a });
  }
  function ir(a, u = {}) {
    let { parse: c } = vi(),
      h = Ue(u),
