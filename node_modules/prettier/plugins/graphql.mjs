...
function yt(e, t) {
  let n = null,
    r = t;
  for (; r !== n; ) (n = r), (r = _e(e, r)), (r = Ie(e, r)), (r = $(e, r));
  return (r = Oe(e, r)), (r = j(e, r)), r !== !1 && De(e, r);
}
var ge = yt;
function It(e) {
...
function kt(e, t, n) {
  ...
  switch (r.kind) {
    ...
    case "SelectionSet":
      return ["{", x([f, E(f, A(e, t, n, "selections"))]), f, "}"];
    case "Field":
      return y([
        r.alias ? [n("alias"), ": "] : "",
        n("name"),
...
`,
    ...
    case "InterfaceTypeDefinition": {
      let { kind: i } = r,
        s = [];
      return (
        i.endsWith("TypeDefinition") ? s.push(g(e, t, n)) : s.push("extend "),
        ...
        s.push(_(e, n, r)),
        r.fields.length > 0 &&
          s.push([" {", x([f, E(f, A(e, t, n, "fields"))]), f, "}"]),
        s
      );
    }
    ...
    case "EnumTypeDefinition":
      return [
        ...
        _(e, n, r),
        r.values.length > 0
          ? [" {", x([f, E(f, A(e, t, n, "values"))]), f, "}"]
          : "",
      ];
    case "EnumValueDefinition":
      return [g(e, t, n), n("name"), _(e, n, r)];
    ...
    case "SchemaExtension":
      return [
        ...
        ...(r.operationTypes.length > 0
          ? [" {", x([f, E(f, A(e, t, n, "operationTypes"))]), f, "}"]
          : []),
      ];
    case "SchemaDefinition":
      return [
        ...
        " {",
        r.operationTypes.length > 0
          ? x([f, E(f, A(e, t, n, "operationTypes"))])
          : "",
        f,
        "}",
      ];
...
function A(e, t, n, r) {
  return e.map(({ isLast: i, node: s }) => {
    let a = n();
    return !i && ge(t.originalText, X(s)) ? [a, f] : a;
  }, r);
}
function Ct(e) {
...
function B(e, t) {
  let n = 0,
    r = 1;
  for (let i of e.body.matchAll(Rt)) {
...
var W = class e extends Error {
  constructor(t, ...n) {
    ...
    super(t),
      ...
      (this.nodes = Be(Array.isArray(a) ? a : a ? [a] : void 0));
    let I = Be(
    ...
    let ie = Pe(h == null ? void 0 : h.extensions)
      ? h == null
        ? void 0
        : h.extensions
      : void 0;
...
function K(e, t) {
  return Je(e.charCodeAt(t)) && Xe(e.charCodeAt(t + 1));
}
function Je(e) {
...
function wt(e, t) {
  ...
  for (; i < r; ) {
    ...
    if (L(s) || s === 45) return Bt(e, i, s);
    if (he(s)) return $t(e, i);
    throw d(
      e.source,
      i,
      s === 39
        ...
        : R(s) || K(n, i)
        ? `Unexpected character: ${S(e, i)}.`
        : `Invalid character: ${S(e, i)}.`,
    );
  }
...
function Bt(e, t, n) {
  ...
  if ((s === 45 && (s = r.charCodeAt(++i)), s === 48)) {
    if (((s = r.charCodeAt(++i)), L(s)))
      throw d(
        e.source,
        i,
        `Invalid number, unexpected digit after 0: ${S(e, i)}.`,
      );
  ...
  if (
    ...
    throw d(e.source, i, `Invalid number, expected digit but got: ${S(e, i)}.`);
  return m(e, a ? o.FLOAT : o.INT, t, i, r.slice(t, i));
}
function de(e, t, n) {
  if (!L(n))
    throw d(e.source, t, `Invalid number, expected digit but got: ${S(e, t)}.`);
  let r = e.source.body,
    i = t + 1;
...
function Ut(e, t) {
  ...
  for (; i < r; ) {
    ...
    else throw d(e.source, i, `Invalid character within String: ${S(e, i)}.`);
  }
...
function Yt(e, t) {
  ...
  if (Je(r) && n.charCodeAt(t + 6) === 92 && n.charCodeAt(t + 7) === 117) {
    let i = Ge(n, t + 8);
    if (Xe(i)) return { value: String.fromCodePoint(r, i), size: 12 };
  }
  throw d(
    e.source,
    t,
...
`),
    ...
    else throw d(e.source, s, `Invalid character within String: ${S(e, s)}.`);
  }
...
function Jt(e, t) {
  ...
  } else if (Array.isArray(e)) return Qt(e, n);
  return qt(e, n);
}
function Xt(e) {
...
var me = class {
  ...
  expectToken(t) {
    ...
    throw d(this._lexer.source, n.start, `Expected ${He(t)}, found ${ne(n)}.`);
  }
...
function zt(e) {
  ...
  for (let i = n; i !== r; i = i.next) i.kind === "Comment" && t.push(i);
  return t;
}
...
function Zt(e) {
  if ((e == null ? void 0 : e.name) === "GraphQLError") {
    ...
    return ze(t, { loc: { start: n }, cause: e });
  }
  return e;
}
function en(e) {
...
var nn = { bracketSpacing: Ze.bracketSpacing },
  et = nn;
var rn = { graphql: Re };
var pr = Te;
export {
