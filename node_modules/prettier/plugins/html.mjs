...
var Hr = (t, e) => {
  for (var r in e) Is(t, r, { get: e[r], enumerable: !0 });
};
var Vr = (t, e, r) => {
...
var xe = $s;
var Ms = (t) => new Intl.ListFormat("en-US", { type: "disjunction" }).format(t);
function Os(t) {
...
function Kr(t, e) {
  return Q(t), { type: oe, contents: t, groupId: e.groupId, negate: e.negate };
}
var J = { type: le };
var qs = { type: V, hard: !0 },
  Hs = { type: V, hard: !0, literal: !0 },
  _ = { type: V },
  x = { type: V, soft: !0 },
  S = [qs, J],
  Xr = [Hs, J];
...
tn.ignoredProperties = zs;
var rn = tn;
var Ys = (t) => t.split(/[/\\]/).pop();
function nn(t, e) {
  if (!e) return;
  let r = Ys(e).toLowerCase();
  return t.find((n) => {
    var s, i;
    return (
...
function He(t) {
  return t.type === "attribute" || !t.parent || !t.prev ? !1 : ei(t.prev);
}
function ei(t) {
      ...
      : !(
          (!t.prev &&
            (t.parent.type === "root" ||
              ...
              M(t.parent) ||
              We(t.parent, e) ||
              !ai(t.parent.cssDisplay))) ||
          (t.prev && !li(t.prev.cssDisplay))
        );
  }
}
function mn(t, e) {
  return Be(t)
    ...
    : !(
        ...
        (t.next && !oi(t.next.cssDisplay))
      );
}
function dn(t) {
  return ci(t.cssDisplay) && !M(t);
}
function Ve(t) {
  return (
    Be(t) ||
...
function gt(t) {
  return An(t) || (t.prev && ti(t.prev)) || Cn(t);
}
function ti(t) {
...
function Dn(t, e) {
  ...
  if (t.type === "element" && t.namespace === "svg")
    if (pi(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
  ...
  switch (e.htmlWhitespaceSensitivity) {
    ...
    default:
      return (
        (t.type === "element" && (!t.namespace || r || pe(t)) && an[t.name]) ||
        sn
      );
  }
}
function vn(t) {
  return (t.type === "element" && (!t.namespace || pe(t)) && on[t.name]) || un;
}
function hi(t) {
...
var fi = new Set(["template", "style", "script"]);
function We(t, e) {
  return fe(t, e) && !fi.has(t.fullName);
}
function fe(t, e) {
  return (
    e.parser === "vue" &&
...
function wn(t) {
  return (t >= 97 && t <= 102) || (t >= 65 && t <= 70) || mi(t);
}
function cr(t) {
  return t === 10 || t === 13;
}
...
var di = /-+([a-z0-9])/g;
function kn(t) {
  return t.replace(di, (...e) => e[1].toUpperCase());
}
var ee = class t {
    constructor(e, r, n, s) {
...
var gi = [Si, Ei, _i, vi, yi, Ti, bi, wi, xi, Di];
function Ci(t, e) {
  for (let r of gi) r(t, e);
  return t;
}
function Si(t) {
  t.walk((e) => {
...
var Pn = Bi;
function ze(t, e) {
  return [t.isSelfClosing ? "" : Li(t, e), Ye(t, e)];
}
function Li(t, e) {
  return t.lastChild && Ce(t.lastChild) ? "" : [Fi(t, e), Dt(t, e)];
}
function Ye(t, e) {
...
function Pi(t, e, r) {
  ...
  let s =
    ...
    c = [U([u ? " " : _, Z(p, a)])];
  return (
    (n.firstChild && Ke(n.firstChild)) || (n.isSelfClosing && ge(n.parent)) || u
...
function Xe(t, e, r) {
  let { node: n } = t;
  return [Qe(n, e), Pi(t, e, r), n.isSelfClosing ? "" : Ii(n)];
}
function Qe(t, e) {
...
async function Vn(t, e, r, n) {
  let s = k(r.node),
    { left: i, operator: a, right: u } = Yi(s),
    o = Pe(r, n);
  return [
    D(
...
var Qi = dr({ parser: "__ng_action" }),
  Ji = dr({ parser: "__ng_binding" }),
  Zi = dr({ parser: "__ng_directive" });
function ea(t, e) {
  if (e.parser !== "angular") return;
  let { node: r } = t,
    n = r.fullName;
  if ((n.startsWith("(") && n.endsWith(")")) || n.startsWith("on-")) return Qi;
  if (
...
var sa = 10;
for (let t = 0; t <= sa; t++) et();
function gr(t) {
  return et(t);
}
function ia(t, e = "type") {
  gr(t);
  function r(n) {
    let s = n[e],
      i = t[s];
...
var la = {
  ...
  rs = la;
var Ir = {};
Hr(Ir, { angular: () => ru, html: () => tu, lwc: () => su, vue: () => nu });
var Ec = new RegExp(
  `(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`,
  "g",
);
...
var ca = "boolean",
  ...
  da = Array.from(as).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
  Lt = class extends Bt {
    constructor() {
      super(),
            ...
            if (c.length > 0)
              switch (c[0]) {
                ...
                case "!":
                  ...
                  break;
                case "#":
                  r.set(c.substring(1), pa);
                  break;
                case "%":
                  r.set(c.substring(1), fa);
                  break;
                default:
                  r.set(c, ha);
              }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
    ...
    allKnownAttributesOfElement(e) {
      ...
      return Array.from(r.keys()).map((n) => da.get(n) ?? n);
    }
...
var Dr = class t {
    static fromArray(e) {
      return e ? (os("interpolation", e), new t(e[0], e[1])) : vr;
    }
    constructor(e, r) {
...
function Es(t, e, r, n = {}) {
  ...
  return (
    s.tokenize(), new wr(Wa(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
  );
}
var $a = /\r\n?/g;
function Oe(t) {
...
var ut = class {
  ...
  Tr = class {
    constructor(e, r, n) {
      ...
      (this._cursor = n.escapedString ? new xr(e, s) : new Gt(e, s)),
...
`,
    ...
    _tokenizeExpansionForm() {
      ...
      if (Va(this._cursor.peek()) && this._isInExpansionForm())
    ...
    _attemptCharCodeCaseInsensitive(e) {
      return Ua(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
    }
    _requireCharCode(e) {
      let r = this._cursor.clone();
    ...
    _consumeEntity(e) {
      ...
      if ((this._cursor.advance(), this._attemptCharCode(35))) {
        ...
        let n = this._cursor.clone();
        if ((this._attemptCharCodeUntilFn(Ha), this._cursor.peek() != 59))
    ...
    _consumePrefixAndName() {
      let e = this._cursor.clone(),
        r = "";
      for (; this._cursor.peek() !== 58 && !Oa(this._cursor.peek()); )
        this._cursor.advance();
      let n;
  ...
  zt = class {
    ...
    parse(e, r, n, s = !1, i) {
      let a =
        ...
        E = new Fr(g.tokens, u, h, C, s);
      return E.build(), new Lr(E.rootNodes, g.errors.concat(E.errors));
    }
  },
  Fr = class t {
    constructor(e, r, n, s, i) {
...
var Kt = { attrs: !0, children: !0 },
  ...
  Xt = class t {
    ...
    setProperty(e, r) {
      if (this[e] !== r) {
        if ((e in Kt && (r = r.map((n) => this.createChild(n))), !bs.has(e))) {
          this[e] = r;
          return;
        }
...
var Xa = [
  { regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: Qa },
  { regex: /^\[if([^\]]*)]><!$/, parse: Ja },
  { regex: /^<!\s*\[endif]$/, parse: Za },
];
function ws(t, e) {
  if (t.value)
    for (let { regex: r, parse: n } of Xa) {
...
function xs(t, e, r) {
  let {
    ...
    { rootNodes: c, errors: g } = Pr(t, {
      canSelfClose: s,
      allowHtmComponentClosingTags: u,
      isTagNameCaseSensitive: o,
      getTagContentType: p ? (...l) => (p(...l) ? L.RAW_TEXT : void 0) : void 0,
    });
  if (n === "vue") {
    if (
      c.some(
        ...
        for (let d of l.attrs)
          d.namespace ||
            (d.name = E(
              d.name,
              (b) =>
                jt.has(l.name) && (jt.get("*").has(b) || jt.get(l.name).has(b)),
            ));
    },
    F = (l) => {
      l.sourceSpan &&
