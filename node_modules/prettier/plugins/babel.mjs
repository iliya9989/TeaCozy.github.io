...
var cs = (a, t) => () => (t || a((t = { exports: {} }).exports, t), t.exports),
  Vi = (a, t) => {
    for (var e in t) lt(a, e, { get: t[e], enumerable: !0 });
  },
  Ki = (a, t, e, s) => {
    if ((t && typeof t == "object") || typeof t == "function")
      for (let i of Ui(t))
        !$i.call(a, i) &&
          ...
          lt(a, i, {
            get: () => t[i],
            enumerable: !(s = Ri(t, i)) || s.enumerable,
          });
    return a;
  };
var ct = (a, t, e) => (
  ...
  Ki(
    t || !a || !a.__esModule
      ? lt(e, "default", { value: a, enumerable: !0 })
      : e,
    a,
  )
);
var is = cs((De) => {
  ...
  var xt = {
      ...
      Object.keys(e)
        ...
        .map(([s, i]) => [
          ...
          typeof i == "function"
            ...
            ? Object.assign({}, i, zi(i.reflect.split(".")))
            : i,
        ])
        .reduce(
          (s, [i, r]) =>
    ...
    Pt = ({ type: a, prefix: t }) =>
      a === "UpdateExpression" ? ps.UpdateExpression[String(t)] : ps[a],
    Wi = {
...
- Did you mean \`import { "${a}" as foo }\`?`,
      ...
      InvalidLhs: ({ ancestor: a }) => `Invalid left-hand side in ${Pt(a)}.`,
      InvalidLhsBinding: ({ ancestor: a }) =>
        `Binding invalid left-hand side in ${Pt(a)}.`,
    ...
    Gi = {
      ...
      PipeUnparenthesizedBody: ({ type: a }) =>
        `Hack-style pipe body cannot be an unparenthesized ${Pt({
          type: a,
  ...
  function Zi(a) {
    ...
    return function s({ loc: i, details: r }) {
      return qi(SyntaxError, Object.assign({}, e, { loc: i }), {
        clone(n = {}) {
          let o = n.loc || {};
          return s({
            loc: new B(
  ...
  function V(a, t) {
    ...
    for (let s of Object.keys(a)) {
      ...
      e[s] = Zi(
        Object.assign(
          { code: xt.SyntaxError, reasonCode: s, toMessage: h },
          t ? { syntaxPlugin: t } : {},
          o,
        ),
      );
  ...
  var p = Object.assign({}, V(Hi), V(Wi), V(Ji), V`pipelineOperator`(Gi)),
    { defineProperty: er } = Object,
    us = (a, t) => er(a, t, { enumerable: !1, value: a[t] });
  function be(a) {
    return (
      a.loc.start && us(a.loc.start, "index"),
      a.loc.end && us(a.loc.end, "index"),
      a
    );
  }
  var tr = (a) =>
  ...
  function P(a, t = {}) {
    ...
    return (
      ++we,
      Kt.push(a),
      zt.push((e = t.binop) != null ? e : -1),
      qt.push((s = t.beforeExpr) != null ? s : !1),
      Ht.push((i = t.startsExpr) != null ? i : !1),
  ...
  var ir = {
    ...
    eq: P("=", { beforeExpr: g, isAssign: Ae }),
    assign: P("_=", { beforeExpr: g, isAssign: Ae }),
    slashAssign: P("_=", { beforeExpr: g, isAssign: Ae }),
    xorAssign: P("_=", { beforeExpr: g, isAssign: Ae }),
    moduloAssign: P("_=", { beforeExpr: g, isAssign: Ae }),
    incDec: P("++/--", { prefix: q, postfix: sr, startsExpr: m }),
    ...
    _do: A("do", { isLoop: pt, beforeExpr: g }),
    _for: A("for", { isLoop: pt }),
    _while: A("while", { isLoop: pt }),
  ...
  function $(a) {
    return a < 65
      ...
      ? !0
      : a <= 65535
      ? a >= 170 && fr.test(String.fromCharCode(a))
      : gt(a, vs);
  }
  function he(a) {
    return a < 48
  ...
  var Gt = {
    ...
    xr = new Set(Gt.keyword),
    Pr = new Set(Gt.strict),
    Tr = new Set(Gt.strictBind);
  function Ls(a, t) {
      ...
      declareName(t, e, s) {
        ...
        if (e & ee || e & Ve)
          this.checkRedeclarationInScope(i, t, e, s),
            e & Ve ? i.functions.add(t) : i.lexical.add(t),
            e & ee && this.maybeExportDefined(i, t);
        else if (e & _s)
          for (
      ...
      isRedeclaredInScope(t, e, s) {
        return s & F
          ? s & ee
            ...
            : (t.lexical.has(e) &&
                !(t.flags & Bs && t.lexical.values().next().value === e)) ||
  ...
  var It = class extends wt {
      ...
      finalizeComment(t) {
        ...
        if (t.leadingNode !== null || t.trailingNode !== null)
          t.leadingNode !== null && Vs(t.leadingNode, e),
            t.trailingNode !== null && Br(t.trailingNode, e);
        else {
...
`);
      ...
      case 120: {
        let l;
        return (
          ({ code: l, pos: t } = kt(a, t, e, s, 2, !1, n, r)),
  ...
  function kt(a, t, e, s, i, r, n, o) {
    let h = t,
      l;
    return (
      ({ n: l, pos: t } = zs(a, t, e, s, 16, i, r, !1, o, !n)),
  ...
  function zs(a, t, e, s, i, r, n, o, h, l) {
    let c = t,
      u = i === 16 ? xs.hex : xs.decBinOct,
      f = i === 16 ? je.hex : i === 10 ? je.dec : i === 8 ? je.oct : je.bin,
      d = !1,
      x = 0;
  ...
  function qs(a, t, e, s, i, r) {
    ...
    if (n === 123) {
      if (
        (++t,
        ({ code: o, pos: t } = kt(a, t, e, s, a.indexOf("}", t) - t, !0, i, r)),
        ++t,
        o !== null && o > 1114111)
      )
        if (i) r.invalidCodePoint(t, e, s);
        else return { code: null, pos: t };
    } else ({ code: o, pos: t } = kt(a, t, e, s, 4, !1, i, r));
    return { code: o, pos: t };
  }
  var jr = ["at"],
    $r = ["at"];
  ...
  var Vr = new Set([103, 109, 115, 105, 121, 117, 100, 118]),
    O = class {
      constructor(t) {
        (this.type = t.type),
          (this.value = t.value),
          (this.start = t.start),
          (this.end = t.end),
          (this.loc = new de(t.startLoc, t.endLoc));
      }
    },
    vt = class extends It {
      constructor(t, e) {
          ...
          (this.errorHandlers_readInt = {
            invalidDigit: (s, i, r, n) =>
              this.options.errorRecovery
                ? (this.raise(p.InvalidDigit, { at: Ee(s, i, r), radix: n }),
                  !0)
                : !1,
      ...
      skipBlockComment(t) {
        ...
        for (
          this.state.pos = i + t.length, Ue.lastIndex = s + 2;
          Ue.test(this.input) && Ue.lastIndex <= i;

        )
          ++this.state.curLine, (this.state.lineStart = Ue.lastIndex);
        ...
        let r = {
          ...
          loc: new de(e, this.state.curPosition()),
        };
      ...
      skipLineComment(t) {
        ...
        let r = this.state.pos,
          o = {
            ...
            loc: new de(s, this.state.curPosition()),
          };
      ...
      readRegexp() {
        ...
        for (; ; ++r) {
          ...
          if (Ne(l)) throw this.raise(p.UnterminatedRegExp, { at: L(t, 1) });
          if (s) s = !1;
          else {
            if (l === 91) i = !0;
            else if (l === 93 && i) i = !1;
  ...
  var Bt = class extends vt {
      ...
      initializeScopes(t = this.options.sourceType === "module") {
        ...
        return (
          (this.expressionScope = new Mt(this)),
          () => {
            (this.state.labels = e),
      ...
      class extends a {
        ...
        flowParseDeclareFunction(e) {
          ...
          return (
            ...
            this.semicolon(),
            this.scope.declareName(e.id.name, vr, e.id.loc.start),
        ...
        flowParseDeclareVariable(e) {
          return (
            ...
            this.scope.declareName(e.id.name, Ye, e.id.loc.start),
            this.semicolon(),
        ...
        flowParseInterfaceish(e, s) {
          if (
            ...
            this.scope.declareName(e.id.name, s ? js : ce, e.id.loc.start),
            this.match(47)
            ...
            if (this.eat(0))
              x != null && this.unexpected(x),
                this.eat(0)
                  ...
                  : h.indexers.push(this.flowParseObjectTypeIndexer(C, d, w));
              ...
              let _e = this.flowParseObjectTypeProperty(
                C,
                d,
                x,
                w,
        ...
        getArrowLikeExpressions(e, s) {
          ...
          return s
            ...
            : Qr(r, (n) => n.params.every((o) => this.isAssignable(o, !0)));
        }
        ...
        getTokenFromCode(e) {
          ...
          e === 123 && s === 124
            ...
            ? s === 46
              ? this.finishOp(18, 2)
              : this.finishOp(17, 1)
            : br(e, s, this.input.charCodeAt(this.state.pos + 2))
        ...
        parseImportSpecifier(e, s, i, r, n) {
          ...
          if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
            ...
            h !== null && !M(this.state.type)
              ? ((e.imported = u), (e.importKind = h), (e.local = z(u)))
              : ((e.imported = o),
                (e.importKind = null),
  ...
  var ta = (a) =>
      class extends a {
        jsxReadToken() {
          ...
          for (;;) {
            if (this.state.pos >= this.length)
              throw this.raise(G.UnterminatedJsxContent, {
                at: this.state.startLoc,
              });
...
`))
        ...
        jsxParseAttributeValue() {
          ...
          switch (this.state.type) {
            case 5:
              return (
                ...
                e.expression.type === "JSXEmptyExpression" &&
                  this.raise(G.AttributeIsEmpty, { at: e }),
                e
              );
            case 140:
            case 131:
            ...
            default:
              throw this.raise(G.UnsupportedJsxValue, {
                at: this.state.startLoc,
              });
          }
        }
        ...
        jsxParseElementAt(e) {
          ...
          if (!r.selfClosing) {
            ...
            H(r) && !H(n) && n !== null
              ? this.raise(G.MissingClosingTagFragment, { at: n })
              : !H(r) && H(n)
              ? this.raise(G.MissingClosingTagElement, {
                  at: n,
          ...
          if (
            ...
            throw this.raise(G.UnwrappedAdjacentJSXElements, {
              at: this.state.startLoc,
            });
          return H(r)
        ...
        updateContext(e) {
          ...
          if (i === 56 && e === 140)
            ...
            (r === E.j_oTag && e === 56) || r === E.j_cTag
              ...
              : (this.setContext(E.j_expr),
                (this.state.canStartJSXElement = !0));
          } else this.state.canStartJSXElement = ar(i);
        }
      },
    _t = class extends ke {
      constructor(...t) {
    ...
    Rt = class extends ve {
      ...
      createScope(t) {
        return this.importsStack.push(new Set()), new _t(t);
      }
      enter(t) {
      ...
      declareName(t, e, s) {
        ...
        super.declareName(t, e, s),
          e & te &&
            ...
            i.types.add(t)),
          e & bt && i.enums.add(t),
          e & At && i.constEnums.add(t),
          e & Ge && i.classes.add(t);
      }
      isRedeclaredInScope(t, e, s) {
        if (t.enums.has(e)) {
          if (s & bt) {
    ...
    sa = (a, t) => Object.hasOwnProperty.call(a, t) && a[t],
    Ys = (a) => (a.type === "ParenthesizedExpression" ? Ys(a.expression) : a),
    Ut = class extends Ft {
      toAssignable(t, e = !1) {
        var s, i;
        let r;
      ...
      checkIdentifier(t, e, s = !1) {
        this.state.strict &&
          (s ? Os(t.name, this.inModule) : Ms(t.name)) &&
          (e === W
  ...
  var oa = (a) =>
    class extends a {
      ...
      tsParseDelimitedList(e, s, i) {
        return ra(this.tsParseDelimitedListWorker(e, s, !0, i));
      }
      ...
      tsParseTypeOperatorOrHigher() {
        return pr(this.state.type) && !this.state.containsEsc
      ...
      tsParseInterfaceDeclaration(e, s = {}) {
        ...
        this.expectContextual(127),
          ...
          S(this.state.type)
            ? ((e.id = this.parseIdentifier()), this.checkIdentifier(e.id, Cr))
            : ((e.id = null),
      ...
      tsParseEnumDeclaration(e, s = {}) {
        return (
          ...
          (e.id = this.parseIdentifier()),
          this.checkIdentifier(e.id, e.const ? Nr : $s),
          this.expect(5),
      ...
      tsParseModuleOrNamespaceDeclaration(e, s = !1) {
        if (
          ((e.id = this.parseIdentifier()),
          s || this.checkIdentifier(e.id, kr),
          this.eat(16))
        ) {
          let i = this.startNode();
          ...
          let o,
            h = this.tsTryParseAndCatch(() => {
              ...
              if (
                c === 48 ||
                c === 52 ||
                (c !== 10 && Tt(c) && !this.hasPrecedingLineBreak())
              )
                return;
      ...
      parseImportSpecifier(e, s, i, r, n) {
        return !s && r
          ...
          : ((e.importKind = "value"),
            super.parseImportSpecifier(e, s, i, r, i ? ms : Ie));
      }
      parseTypeOnlyImportExportSpecifier(e, s, i) {
        ...
        (e[f] = l ? "type" : "value"),
          ...
          e[n] || (e[n] = z(e[r])),
          s && this.checkIdentifier(e[n], l ? ms : Ie);
      }
    };
  function ha(a) {
      ...
      class extends a {
        ...
        parseClass(e, s, i) {
          ...
          if (o)
            if (this.match(81) || this.match(142) || this.match(5)) e.id = o;
              ...
              throw this.raise(As.ClassNameIsRequired, {
                at: this.state.startLoc,
              });
            }
        ...
        assertNoSpace() {
          this.state.start > this.state.lastTokEndLoc.index &&
            this.raise(As.UnexpectedSpace, { at: this.state.lastTokEndLoc });
        }
      },
    ua = (a) =>
      class extends a {
  ...
  var Ss = ["minimal", "fsharp", "hack", "smart"],
    Es = ["^^", "@@", "^", "%", "#"],
    Cs = ["hash", "bar"];
  function da(a) {
    if (k(a, "decorators")) {
    ...
    if (
      k(a, "recordAndTuple") &&
      Y(a, "recordAndTuple", "syntaxType") != null &&
      !Cs.includes(Y(a, "recordAndTuple", "syntaxType"))
    )
      throw new Error(
  ...
  function ma(a) {
    ...
    let t = {};
    for (let e of Object.keys(ws)) t[e] = a && a[e] != null ? a[e] : ws[e];
    return t;
  }
  var jt = class extends Ut {
      ...
      parseExprOp(t, e, s) {
        if (this.isPrivateName(t)) {
          ...
          (s >= $e(58) || !this.prodParam.hasIn || !this.match(58)) &&
      ...
      parseSubscript(t, e, s, i) {
        ...
        if (We(r)) return this.parseTaggedTemplateExpression(t, e, i);
        let n = !1;
        if (r === 18) {
          if (
            s &&
      ...
      parseCoverCallAndAsyncArrowHead(t, e, s, i) {
        ...
        h && (this.expressionScope.enter(Hr()), (n = new ue())),
          l && (o.optional = i),
          i
      ...
      parseAsyncArrowFromCallExpression(t, e) {
        ...
        return (
          ...
          e.innerComments && Le(t, e.innerComments),
          e.callee.trailingComments && Le(t, e.callee.trailingComments),
          t
        );
      }
      parseNoCallExpr() {
      ...
      parseAsyncArrowUnaryFunction(t) {
        this.prodParam.enter(ze(!0, this.prodParam.hasYield));
        let e = [this.parseIdentifier()];
        return (
          this.prodParam.exit(),
          this.hasPrecedingLineBreak() &&
...
`,
      ...
      parseMethod(t, e, s, i, r, n, o = !1) {
        this.initFunction(t, s),
          (t.generator = e),
          this.scope.enter(K | Je | (o ? Z : 0) | (r ? Fs : 0)),
          this.prodParam.enter(ze(s, t.generator)),
      ...
      parseFunctionBody(t, e, s = !1) {
        ...
        if ((this.expressionScope.enter(Js()), i))
          ...
          let r = this.state.strict,
            n = this.state.labels;
          (this.state.labels = []),
            this.prodParam.enter(this.prodParam.currentFlags() | Gs),
            (t.body = this.parseBlock(!0, !1, (o) => {
              ...
              this.checkParams(t, !this.state.strict && !e && !s && !h, e, l),
                this.state.strict && t.id && this.checkIdentifier(t.id, Ir, l);
            })),
            this.prodParam.exit(),
            (this.state.labels = n);
        }
  ...
  var $t = class extends jt {
      parseTopLevel(t, e) {
        return (
          ...
          (t.comments = this.state.comments),
          this.options.tokens && (t.tokens = Pa(this.tokens, this.input)),
      ...
      parseCatchClauseParam() {
        ...
        return (
          this.scope.enter(
            this.options.annexB && t.type === "Identifier" ? Bs : 0,
          ),
          this.checkLVal(t, { in: { type: "CatchClause" }, binding: Er }),
          t
        );
      }
      parseTryStatement(t) {
      ...
      parseFunction(t, e = 0) {
        ...
        return (
          (this.state.maybeInArrowParameters = !1),
          this.scope.enter(K),
          this.prodParam.enter(ze(n, t.generator)),
      ...
      parseInitializer(t) {
        this.scope.enter(Z | Je),
          this.expressionScope.enter(Js()),
          this.prodParam.enter(pe),
      ...
      parseExportSpecifier(t, e, s, i) {
        return (
          this.eatContextual(93)
            ...
            : e
            ? (t.exported = Jr(t.local))
            : t.exported || (t.exported = z(t.local)),
    ...
    et = class extends $t {
      constructor(t, e) {
        (t = ma(t)),
          ...
          (this.plugins = Ta(this.options.plugins)),
  ...
  function Ce(a, t) {
    let e = et;
    return (
      a != null && a.plugins && (da(a.plugins), (e = Ea(a.plugins))),
      new e(a, t)
    );
  }
  var Is = {};
  function Ea(a) {
    let t = fa.filter((i) => k(a, i)),
      e = t.join("/"),
      s = Is[e];
    if (!s) {
      s = et;
      for (let i of t) s = ei[i](s);
      Is[e] = s;
    }
    return s;
  }
...
`;
    ...
    let e = "";
    for (; e !== a; ) (e = a), (a = a.replace(Oa, `${t}$1 $2${t}`));
    a = a.replace(hi, "").trimRight();
    let s = Object.create(null),
      i = a.replace(li, "").replace(hi, "").trimRight(),
      r;
    for (; (r = li.exec(a)); ) {
      let n = r[2].replace(Ma, "");
      typeof s[r[1]] == "string" || Array.isArray(s[r[1]])
        ? (s[r[1]] = ui.concat(s[r[1]], n))
        : (s[r[1]] = n);
    }
...
function Va(a) {
  return (
    ...
    { astFormat: "estree", hasPragma: mi, locStart: D, locEnd: _, ...a }
  );
}
var xe = Va;
function Ka(a, t) {
...
var yi = Ha;
var Wa = yi(["Block", "CommentBlock", "MultiLine"]),
  Oe = Wa;
function Ja(a) {
...
function Fe(a) {
  ...
  return (Be = Fe.prototype = a ?? Object.create(null)), new Fe();
}
var Ga = 10;
for (let a = 0; a <= Ga; a++) Fe();
function ns(a) {
  return Fe(a);
}
...
function os(a, t) {
  ...
  if (Array.isArray(a)) {
    for (let s = 0; s < a.length; s++) a[s] = os(a[s], t);
    return a;
  }
  let e = gi(a);
  for (let s = 0; s < e.length; s++) a[e[s]] = os(a[e[s]], t);
  return t(a) || a;
}
var nt = os;
function Za(a, t) {
...
var Pe = (a) => xe(hn(a)),
  ...
  rn = ["recordAndTuple", { syntaxType: "hash" }],
  Ei = "v8intrinsic",
  Ci = [
  ...
  R = (a, t = sn) => ({ ...t, plugins: [...t.plugins, ...a] }),
  an = /@(?:no)?flow\b/;
function nn(a, t) {
  var i;
  ...
  let s = oi(a, 0);
  return s !== !1 && (a = a.slice(0, s)), an.test(a);
}
function on(a, t, e) {
  let s = a(t, e),
    i = s.errors.find((r) => !ln.has(r.reasonCode));
  if (i) throw i;
  return s;
}
function hn({ isExpression: a = !1, optionsCombinations: t }) {
  return (e, s = {}) => {
    if ((s.parser === "babel" || s.parser === "__babel_estree") && nn(e, s))
      return (s.parser = "babel-flow"), Li.parse(e, s);
    let i = t;
    (s.__babelSourceType ?? Si(s)) === "script" &&
      (i = i.map((l) => ({ ...l, sourceType: "script" }))),
      /#[[{]/.test(e) && (i = i.map((l) => R([rn], l)));
    let n = /%[A-Z]/.test(e);
    e.includes("|>")
      ? (i = (n ? [...Ci, Ei] : Ci).flatMap((c) => i.map((u) => R([c], u))))
      : n && (i = i.map((l) => R([Ei], l)));
    let o = a ? ht.parseExpression : ht.parse,
      h;
    try {
    ...
    return (
      a && (h = ot(h, { text: e, rootMarker: s.rootMarker })),
      Ai(h, { parser: "babel", text: e })
    );
  };
}
var ln = new Set([
  ...
  vi = [R(["jsx"])],
  wi = Pe({ optionsCombinations: vi }),
  Ii = Pe({
    optionsCombinations: [R(["jsx", "typescript"]), R(["typescript"])],
  }),
  Ni = Pe({ isExpression: !0, optionsCombinations: [R(["jsx"])] }),
  ki = Pe({ isExpression: !0, optionsCombinations: [R(["typescript"])] }),
  Li = Pe({
    optionsCombinations: [
      R(["jsx", ["flow", { all: !0, enums: !0 }], "flowComments"]),
    ],
  }),
  cn = Pe({ optionsCombinations: vi.map((a) => R(["estree"], a)) }),
  Di = {
    babel: wi,
    "babel-flow": Li,
    "babel-ts": Ii,
    ...
    __ts_expression: ki,
    __vue_expression: Ni,
    __vue_ts_expression: ki,
    __vue_event_binding: wi,
    __vue_ts_event_binding: Ii,
    __babel_estree: cn,
  };
var Oi = ct(is(), 1);
function Bi(a = {}) {
  ...
  return function (s) {
    let i;
    try {
      i = (0, Oi.parseExpression)(s, { tokens: !0, ranges: !0 });
    } catch (r) {
      throw (r == null ? void 0 : r.reasonCode) === "MissingPlugin" ||
        (r == null ? void 0 : r.reasonCode) === "MissingOneOfPlugins"
        ? Me({ message: "Unexpected token", loc: r.loc })
        : Me(r);
    }
    if (!t && ie(i.comments)) throw X(i.comments[0], "Comment");
    return Te(i), ot(i, { type: "JsonRoot", text: s });
  };
}
function X(a, t) {
  ...
  return at(`${t} is not allowed in JSON.`, { loc: { start: e, end: s } });
}
function Te(a) {
  switch (a.type) {
    case "ArrayExpression":
      for (let t of a.elements) t !== null && Te(t);
      return;
    case "ObjectExpression":
      for (let t of a.properties) Te(t);
      return;
    case "ObjectProperty":
      if (a.computed) throw X(a.key, "Computed key");
      if (a.shorthand) throw X(a.key, "Shorthand property");
      a.key.type !== "Identifier" && Te(a.key), Te(a.value);
      return;
    case "UnaryExpression": {
      let { operator: t, argument: e } = a;
      if (t !== "+" && t !== "-") throw X(a, `Operator '${a.operator}'`);
      if (
...
var un = { ...Di, ...Fi };
var Ko = ls;
export { Ko as default, un as parsers };
