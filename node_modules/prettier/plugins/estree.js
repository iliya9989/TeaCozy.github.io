(function (f) {
  ...
  var la = (e, t, r) => (
    ...
    ma = (e) => Bs(pr({}, "__esModule", { value: !0 }), e);
  var bs = (e, t, r) => {
...
`,
  ...
  var Dl = {};
  cr(Dl, { languages: () => yl, options: () => sa, printers: () => ml });
  var hs = {};
  cr(hs, {
    canAttachComment: () => Wo,
    embed: () => Ni,
  ...
  var Ke = "string",
    ...
    be = "label",
    Pe = "break-parent",
    lr = new Set([ze, Me, Re, Qe, ue, ye, Fe, Je, Ne, Ue, ie, be, Pe]);
  function Da(e) {
    if (typeof e == "string") return Ke;
    if (Array.isArray(e)) return je;
    if (!e) return;
    let { type: t } = e;
    if (lr.has(t)) return t;
  }
  var Ze = Da;
  var fa = (e) =>
...
`),
  ...
  function Gs(e, { getVisitorKeys: t, predicate: r }) {
...
` ||
  ...
  var dr = Xa;
  function Xt(e, t) {
    return t(e) || Gs(e, { getVisitorKeys: Fr, predicate: t });
  }
  function Lt(e) {
    return (
  ...
  function Ct(e, t) {
    ...
    if (e.arguments.length === 1) {
      if (kn(e) && t && Ct(t)) return It(e.arguments[0]);
      if (Ha(e)) return kn(e.arguments[0]);
    } else if (
...
`),
  ...
  function hr(e, t) {
    return (
      ((e.type === "TemplateLiteral" && Ks(e)) ||
        (e.type === "TaggedTemplateExpression" && Ks(e.quasi))) &&
      !z(t, U(e), { backwards: !0 })
    );
  }
  function Sr(e) {
  ...
  function xe(e, t = 2) {
    if (t <= 0) return !1;
    let r = (n) => xe(n, t - 1);
    if (On(e)) return tt(e.pattern ?? e.regex.pattern) <= 5;
    if (
      e.type === "Literal" ||
...
`),
  ...
  function ou(e, t) {
    ...
    return r.type === "FunctionExpression" || r.type === "ClassExpression"
      ? n.type === "ExportDefaultDeclaration" || !Jn(e, t)
      : !Lt(r) || (n.type !== "ExportDefaultDeclaration" && Jn(e, t))
      ? !1
      : e.call(() => ou(e, t), ...Tr(r));
  }
  function so(e) {
  ...
  function po(e, t, r) {
    ...
    if (
      ...
      let m = pu(i, a(n));
      return { doc: Sn([C, m ? C : "", s]), isBlock: o, hasLineSuffix: !0 };
    }
    return !o || (r != null && r.hasLineSuffix)
      ? { doc: [Sn([" ", s]), Ae], isBlock: o, hasLineSuffix: !0 }
  ...
  function M(e, t, r = {}) {
    ...
    if (
      (e.each(({ node: p }) => {
        p.leading || p.trailing || p.marker !== u || !i(p) || a.push(Nn(e, t));
      }, "comments"),
      a.length === 0)
    )
      return "";
  ...
  function pe(e, t, r) {
    let { leading: n, trailing: s } = Un(e, r);
  ...
  var lu = Wn;
  var zn = {};
  cr(zn, { endOfLine: () => Fo, ownLine: () => Eo, remaining: () => Co });
  function lo(e, t) {
    let r = null,
      n = t;
    for (; n !== r; )
...
`
  ...
  function _e(e, t, r) {
    (t.leading = !1), (t.trailing = !1), r && (t.marker = r), Yn(e, t);
  }
  function te(e, t) {
  ...
  var mu = fo;
  function Eo(e) {
    return [du, Eu, To, $n, Vn, yu, Du, Oo, Lo, Kn, Cu, vo, fu, Fu, Hn].some(
      (t) => t(e),
    );
  }
  function Fo(e) {
    return [Ao, Eu, xo, Cu, $n, Vn, yu, Du, Fu, Io, wo, Kn, Mo, Hn, No].some(
      (t) => t(e),
    );
  }
  function Co(e) {
    return [du, $n, Vn, go, ko, fu, Kn, Po, bo, Jo, Hn, Ro].some((t) => t(e));
  }
  function At(e, t) {
  ...
  function ko({ comment: e, enclosingNode: t, text: r }) {
    return $e(r, O(e)) !== ")"
      ? !1
      : t && ((Au(t) && X(t).length === 0) || (it(t) && he(t).length === 0))
      ? (_e(t, e), !0)
  ...
  function Cu({ comment: e, precedingNode: t, enclosingNode: r, text: n }) {
    if (
  ...
  function du({ comment: e, enclosingNode: t, followingNode: r }) {
    if (
      Ht(e) &&
...
`);
  ...
  function xu(e, t) {
    ...
    if (ae(r)) return Tu(r) ? Go(r) : ["/*", Te(r.value), "*/"];
...
\r	`),
  ...
  function $o(e, t, r) {
    ...
    for (; l.length > 0 && Zn(w(!1, l, -1)); ) l.pop();
        ...
        if (i.type === "JSXText") {
          ...
          if (Zt(i)) {
            ...
            p[0] === "" &&
              (u.push(""),
              p.shift(),
              /\n/.test(p[0]) ? u.push(hu(s, p[1], i, a)) : u.push(n),
              p.shift());
            let m;
            if (
...
`),
  ...
  function ip(e, t, r) {
    ...
    return [
      ...
      e.call(
        ({ node: s }) => {
          let u = ["...", r()];
          return !d(s) || !Qn(e) ? u : [E([F, pe(e, u, t)]), F];
        },
  ...
  function Zt(e) {
    return (
      e.type === "JSXText" &&
      (Ir.hasNonWhitespaceCharacter(oe(e)) || !/\n/.test(oe(e)))
    );
  }
  function op(e) {
    return (
  ...
  function es(e, t, r, n, s) {
    ...
    if ((i.push(o ? "" : " ", l ? y(D, { shouldBreak: f }) : D), n && d(u))) {
      let g = Bt(pe(e, i, r));
      return Array.isArray(g) || g.type === ye ? Dr(g) : [g];
    }
    return i;
  }
  function Ot(e) {
  ...
  function Pu({ node: e }, { originalText: t }) {
    let r = (s) => bt(t, Pt(t, s)),
      n = (s) => (t[s] === "," ? s : n(r(s + 1)));
    return kt(t, n(O(e)));
  }
  function yp(e, t, r, n) {
    ...
    return (
      e.each(({ node: u, isLast: i }) => {
        s.push(u ? y(n()) : ""), i || s.push([",", A, u && Pu(e, t) ? F : ""]);
      }, r),
      s
    );
  }
  function Dp(e, t, r, n) {
    ...
    return (
      e.each(({ isLast: u, next: i }) => {
        s.push([r(), u ? n : ","]),
          u || s.push(Pu(e, t) ? [C, C] : d(i, x.Leading | x.Line) ? C : A);
      }, "elements"),
      St(s)
    );
  }
  function fp(e, t, r) {
    ...
    let D = ["(", E([F, ...a]), P(p), F, ")"];
    return Br(e) ? D : y(D, { shouldBreak: a.some(K) || u });
  }
  function er(e, t = !1) {
    return (
  ...
  function ku(e) {
    var t;
    if (e.type === "ParenthesizedExpression") return ku(e.expression);
  ...
  function Tp(e, t, r) {
    ...
    function a(L) {
      ...
      k(W) && (Dt(W.callee) || k(W.callee))
        ...
        ? (u.unshift({
            node: W,
            needsParens: we(L, t),
            printed: pe(L, J(W) ? rs(L, t, r) : Or(L, t, r), t),
          }),
    ...
    function h(L) {
      var xn;
      let W = (xn = L[1][0]) == null ? void 0 : xn.node.computed;
      if (L[0].length === 1) {
        let or = L[0][0].node;
        return (
          or.type === "ThisExpression" ||
          (or.type === "Identifier" && (f(or.name) || (s && l(or.name)) || W))
        );
      }
    ...
    if (p.length <= R && !N) return Br(e) ? _ : y(_);
  ...
  function vr(e, t, r) {
    ...
    let { node: n, parent: s } = e,
      ...
      a = $(e),
      o = he(n),
      p = o.length === 1 && hr(o[0], t.originalText);
  ...
  function _u(e, t) {
    ...
    switch (r.type) {
      ...
      case "DirectiveLiteral":
        return vu(r.extra.raw, t);
      case "Literal": {
        if (r.regex) return Ou(r.regex);
        if (r.bigint) return _r(r.raw);
  ...
  function bp(e, t, r, n, s) {
    ...
    if (
      ...
      return a
        ? i.type === "ArrowFunctionExpression" &&
          ...
          : "chain-tail"
        : "chain";
    if ((!a && Mr(i.right)) || Ie(t.originalText, i))
    ...
    if (kp(u) || Ip(u) || Op(u) || (ns(u) && Js(n))) return "break-lhs";
    let m = Mp(u, n, t);
  ...
  function Pp(e, t, r, n) {
    ...
    let u = s,
      i = [];
    for (;;)
      if (u.type === "UnaryExpression") (u = u.argument), i.push("argument");
      else if (u.type === "TSNonNullExpression")
        (u = u.expression), i.push("expression");
      else break;
    return !!(ee(u) || e.call(() => Nu(e, t, r), ...i));
  }
  function kp(e) {
    if (Ju(e)) {
      let t = e.left || e.id;
  ...
  function Ju(e) {
    return Mr(e) || e.type === "VariableDeclarator";
  }
  function Ip(e) {
    let t = wp(e);
    if (b(t)) {
  ...
  function Op(e) {
    ...
    return (
      b(r) &&
      r.length > 1 &&
      r.some((n) => b(ju(n)) || n.type === "TSConditionalType")
    );
  }
  function ns(e) {
    var t;
...
`)
  ...
  function as(e, t, r) {
    let { node: n } = e;
    return y([B(A, e.map(r, "decorators")), Xu(n, t) ? C : A]);
  }
  function Wu(e, t, r) {
    return $u(e.node) ? [B(C, e.map(r, "declaration", "decorators")), C] : "";
  }
  function Yu(e, t, r) {
    let { node: n, parent: s } = e,
      { decorators: u } = n;
    if (!b(u) || $u(s) || Lr(e)) return "";
    let i =
      n.type === "ClassExpression" || n.type === "ClassDeclaration" || Xu(n, t);
    return [
      e.key === "declaration" && Zs(s) ? C : i ? Ae : "",
  ...
  function Qr(e, t, r) {
    let { node: n } = e,
      s = [Wu(e, t, r), Q(e), "export", Hu(n) ? " default" : ""],
      { declaration: u, exported: i } = n;
    return (
      d(n, x.Dangling) && (s.push(" ", M(e, t)), Sr(n) && s.push(C)),
      u
  ...
  function Ku(e, t, r) {
    ...
    if (!n.source) return "";
    let s = [];
    return Qu(n, t) || s.push(" from"), s.push(" ", r("source")), s;
  }
  function zu(e, t, r) {
    let { node: n } = e;
    if (Qu(n, t)) return "";
  ...
  function Hp(e) {
    ...
    if (t.type !== r.type || !$s(t, r)) return !1;
  ...
  function tc(e, t) {
    let r = e.lastIndexOf(`
`);
    return r === -1 ? 0 : ti(e.slice(r + 1).match(/^[\t ]*/)[0], t);
  }
  var ri = tc;
  function ni(e) {
    switch (e) {
...
`,
        ...
        case Ne:
          ...
          break;
        case Ue:
          p.length > 0 && i.push({ ind: c, mode: f, doc: Bn });
          break;
        case ie:
          switch (f) {
            case nt:
            ...
            case Ce:
              ...
              l.literal
                ? c.root
                  ...
                  : (a.push(s), (u = 0))
                : ((u -= ls(a)), a.push(s + c.value), (u = c.length));
              break;
          }
          break;
        case be:
  ...
  function en(e, t, r) {
    ...
    o &&
      (a = a.map(
        (m) => ms(m, { ...r, printWidth: Number.POSITIVE_INFINITY }).formatted,
      )),
      i.push(de, "`");
    let p = 0;
    return (
...
`) && o.push({ hasLineBreak: !1, cells: [] });
  ...
  function tn(e, t) {
    return ut(e, (r) =>
      typeof r == "string" ? (t ? H(!1, r, /(\\*)`/g, "$1$1\\`") : ys(r)) : r,
    );
  }
  function ys(e) {
    return H(!1, e, /([\\`]|\${)/g, "\\$1");
  ...
  function gt(e, t, r, n) {
    ...
    if (
      ...
      (!a &&
        (i ||
          (s[n].length === 1 &&
            (s[n][0].type === "NullableTypeAnnotation" || us(s[n][0])))))
    )
  ...
  function nn(e, t, r) {
    ...
    if (s.type === "TSMappedType")
      return (
        s.readonly && u.push(Ds(s.readonly, "readonly"), " "),
        u.push("[", i),
  ...
  function ct(e, t, r) {
    ...
    let { parent: s } = e,
      { key: u } = n;
    if (t.quoteProps === "consistent" && !un.has(s)) {
      let i = (s.properties || s.body || s.members).some(
        (a) => !a.computed && a.key && ee(a.key) && !jn(a, t),
      );
      un.set(s, i);
    }
    if (
      ...
      (t.parser === "json" || (t.quoteProps === "consistent" && un.get(s)))
    ) {
      let i = Tt(
    ...
    return jn(n, t) &&
      (t.quoteProps === "as-needed" ||
        (t.quoteProps === "consistent" && !un.get(s)))
      ? e.call(
  ...
  function ur(e, t, r) {
    ...
    return (
      !s || s === "init" || s === "method" || s === "constructor"
        ...
        : (sn.ok(s === "get" || s === "set"), i.push(s, " ")),
      u.generator && i.push("*"),
      i.push(
        ct(e, t, r),
        n.optional || n.key.optional ? "?" : "",
        n === u ? on(e, t, r) : r("value"),
      ),
      i
    );
  }
  ...
  function Dc(e, t) {
    ...
    if (Lt(t)) {
      let r = t,
        n;
      for (; (n = Qs(r)); ) if (((r = n), Ie(e.originalText, r))) return !0;
    }
    return !1;
  }
  var mi = j([
  ...
  function ln(e, t, r) {
    ...
    } else a.push(fs(e, t, r, "extends"));
    if ((a.push(fs(e, t, r, "mixins"), fs(e, t, r, "implements")), u)) {
      let o;
  ...
  function mn(e, t, r) {
    let { node: n } = e,
      s = [];
    return (
      b(n.decorators) && s.push(as(e, t, r)),
      s.push(jt(n)),
  ...
  function Et(e, t, r) {
    ...
    return e.match((T) => T.type === "ObjectPattern" && !b(T.decorators), Fs) ||
      (ke(s) &&
        (e.match(
          void 0,
  ...
  function Ci(e, t, r, n = {}) {
    ...
    (function g() {
      ...
      if (s.length === 0) s.push(I);
        ...
        let { leading: v, trailing: _ } = Un(e, t);
  ...
  function Cc(e, t, r, n) {
    let { node: s } = e,
      u = [];
    if ((s.async && u.push("async "), pn(e, t))) u.push(r(["params", 0]));
    else {
  ...
  function dc(e, t, r) {
    ...
    return (
      ...
      (((n = t.label) == null ? void 0 : n.hug) !== !1 &&
        (((s = t.label) == null ? void 0 : s.embed) || hr(e, r.originalText)))
    );
  }
  ...
  function ds(e, t, r) {
    ...
    return (
      s &&
        (a.push(ir(e, t, r, "directives")),
        (u || i) && (a.push(C), me(w(!1, n.directives, -1), t) && a.push(C))),
      u && a.push(ir(e, t, r, "body")),
      i && a.push(M(e, t)),
      n.type === "Program" &&
  ...
  function di(e, t) {
    if (t.semi || As(e, t) || xs(e, t)) return !1;
    let { node: r, key: n, parent: s } = e;
    return !!(
  ...
  function Ai(e, t) {
    ...
    return we(e, t) ? !0 : Lt(r) ? e.call(() => Ai(e, t), ...Tr(r)) : !1;
  }
  function As({ node: e, parent: t }, r) {
    return (
  ...
  function Ti(e, t, r) {
    ...
    return (
      xs(e, t)
        ? Ts(e.node.expression) && n.push(";")
        : As(e, t) || (t.semi && n.push(";")),
  ...
  function gi(e, t, r, n) {
    ...
    switch (s.type) {
      ...
      case "BindExpression":
        return (
          s.object && i.push(r("object")), i.push(y(E([F, Or(e, t, r)]))), i
        );
      case "Identifier":
        return [s.name, $(e), Kr(e), q(e, r)];
      ...
      case "IfStatement": {
        ...
        if ((i.push(o), s.alternate)) {
          let p = d(s.consequent, x.Trailing | x.Line) || Sr(s),
    ...
    return (
      b(n.extends) &&
        i.push(
          ...
          "extends ",
          (n.extends.length === 1 ? nu : E)(B([",", A], e.map(r, "extends"))),
        ),
  ...
  function Pi(e, t, r) {
    let { node: n } = e;
    if (Cr(n)) return n.type.slice(0, -14).toLowerCase();
    let s = t.semi ? ";" : "";
    switch (n.type) {
      case "DeclareClass":
        return ln(e, t, r);
  ...
  function ki(e, t, r) {
    ...
    if (dr(n)) return n.type.slice(2, -7).toLowerCase();
    let s = t.semi ? ";" : "",
      u = [];
    switch (n.type) {
      case "TSThisType":
  ...
  function Sc(e, t, r, n) {
    if (Lr(e)) return Is(e, t);
    for (let s of [Si, Su, Pi, ki, gi]) {
      let u = s(e, t, r, n);
...
`),
  ...
  async function Gc(e, t, r) {
    ...
    let a = tn(await e(s, { parser: "markdown", __inJsTemplate: !0 }), !0);
    return ["`", i ? E([F, a]) : [yr, Os(a)], F, "`"];
  }
  function qc(e) {
    let t = e.match(/^([^\S\n]*)\S/m);
    return t === null ? "" : t[1];
...
`) +
  ...
  var Nt = "JavaScript",
    ...
    sa = ll;
  var ml = { estree: hs, "estree-json": Ss },
    yl = [...Qi, ...na];
  return ma(Dl);
});
