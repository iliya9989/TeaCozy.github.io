(function (f) {
  ...
  var ct = (a, t, e) => (
      ...
      cs(
        t || !a || !a.__esModule
          ? Re(e, "default", { value: a, enumerable: !0 })
          : e,
        a,
      )
    ),
    Ki = (a) => cs(Re({}, "__esModule", { value: !0 }), a);
  var is = ls((De) => {
    "use strict";
        ...
        declareName(t, e, s) {
          ...
          if (e & ee || e & Ke)
            this.checkRedeclarationInScope(i, t, e, s),
              e & Ke ? i.functions.add(t) : i.lexical.add(t),
...
`);
    ...
    function zs(a, t, e, s, i, r, n, o, h, l) {
      let c = t,
        ...
        f = i === 16 ? $e.hex : i === 10 ? $e.dec : i === 8 ? $e.oct : $e.bin,
        d = !1,
        x = 0;
              ...
              i.forEach((o) => {
                Gr(o)
                  ...
                  : o.type === "DeclareModuleExports" &&
                    (n &&
                      this.raise(T.DuplicateDeclareModuleExports, { at: o }),
                    r === "ES" &&
                      this.raise(T.AmbiguousDeclareModuleKind, { at: o }),
                    (r = "CommonJS"),
                    (n = !0));
            ...
            super.parseClassMember(e, s, i),
              s.declare &&
                ...
                s.type !== "PropertyDefinition"
                  ...
                  : s.value &&
                    this.raise(T.DeclareClassFieldInitializer, {
                      at: s.value,
                    }));
          }
          isIterator(e) {
...
`,
        ...
        parseMethod(t, e, s, i, r, n, o = !1) {
          this.initFunction(t, s),
            (t.generator = e),
            this.scope.enter(K | Xe | (o ? Z : 0) | (r ? Fs : 0)),
            ...
            (this.state.labels = []),
              ...
              (t.body = this.parseBlock(!0, !1, (o) => {
                ...
                this.checkParams(t, !this.state.strict && !e && !s && !h, e, l),
                  this.state.strict &&
                    t.id &&
                    this.checkIdentifier(t.id, Ir, l);
              })),
              this.prodParam.exit(),
              (this.state.labels = n);
          }
