(function (f) {
  ...
  var rr = (t, e, n) => (
    ...
    ki = (t) => nr(yt({}, "__esModule", { value: !0 }), t);
  var le = ee((U) => {
    "use strict";
    var re = {
        ANCHOR: "&",
...
${n}`,
          ...
          "'";
      return e.implicitKey ? r : Wt(r, n, Ys, qn(e));
    }
...
${a}`
    ...
    function jo(t, e) {
      ...
      for (let o = 0; o < r.length; ++o) {
        let { key: a } = r[o];
        if (
          (a instanceof W && (i = !0), t.schema.merge && a && a.value === Ds)
        ) {
          r[o] = new Vt(r[o]);
...
`
    ...
    Y._defineProperty(en, "defaults", ci);
    tn.Document = en;
    tn.defaultOptions = La;
    tn.scalarOptions = Aa;
  });
  var pi = ee((ui) => {
    "use strict";
...
`);
  ...
  function no(t, e) {
    ...
    if (
      (t.isFirst &&
        /---(?:\s|$)/.test(e.originalText.slice(ve(n), ve(n) + 4))) ||
...
`,
        ...
        for (var n = [0], r = 0; r < e.length; )
          switch (e[r]) {
            case kt:
              ...
              break;
            case Ir:
              (r += Ir.length), e[r] === kt && (r += kt.length), n.push(r);
              break;
            default:
              r++;
              break;
  ...
  var di = rr(hi(), 1);
  var J = rr(gi(), 1),
    xm = J.default.findPair,
    Rm = J.default.toJSON,
    Dm = J.default.parseMap,
    Ym = J.default.parseSeq,
    Bm = J.default.stringifyNumber,
    $m = J.default.stringifyString,
    Fm = J.default.Type,
    qa = J.default.YAMLError,
    qm = J.default.YAMLReferenceError,
    Zn = J.default.YAMLSemanticError,
    Ua = J.default.YAMLSyntaxError,
    Um = J.default.YAMLWarning;
