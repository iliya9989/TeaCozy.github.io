(function (f) {
  ...
  var Hr = (t, e) => {
      for (var r in e) Jt(t, r, { get: e[r], enumerable: !0 });
    },
    Ms = (t, e, r, n) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let s of Rs(e))
          !$s.call(t, s) &&
            ...
            Jt(t, s, {
              get: () => e[s],
              enumerable: !(n = Is(e, s)) || n.enumerable,
            });
      return t;
    };
  var Os = (t) => Ms(Jt({}, "__esModule", { value: !0 }), t);
  var Vr = (t, e, r) => {
    if (!e.has(t)) throw TypeError("Cannot " + r);
  };
  var z = (t, e, r) => (
      Vr(t, e, "read from private field"), r ? r.call(t) : e.get(t)
    ),
    Ur = (t, e, r) => {
      if (e.has(t))
    ...
    Wr = (t, e, r, n) => (
      Vr(t, e, "write to private field"), n ? n.call(t, r) : e.set(t, r), r
    );
  var pu = {};
  Hr(pu, {
    languages: () => Ls,
  ...
  var _e = "string",
    ...
    Te = "label",
    le = "break-parent",
    lt = new Set([ve, se, ie, ye, X, ae, ue, oe, be, we, V, Te, le]);
  function Hs(t) {
...
Expected it to be ${n}.`;
  ...
  var Gr = () => {},
    ...
    pt = Gr;
  function U(t) {
    return Q(t), { type: se, contents: t };
  }
  function zr(t, e) {
    return Q(e), { type: ie, contents: e, n: t };
  }
  function D(t, e = {}) {
    return (
      Q(t),
      pt(e.expandedStates, !0),
      {
        type: X,
        id: e.id,
        contents: t,
  ...
  function Yr(t) {
    return zr(Number.NEGATIVE_INFINITY, t);
  }
  function jr(t) {
    return zr({ type: "root" }, t);
  }
  function ht(t) {
    return pt(t), { type: ae, parts: t };
  }
  function ce(t, e = "", r = {}) {
    return (
      Q(t),
  ...
  function Kr(t, e) {
    return (
      Q(t), { type: oe, contents: t, groupId: e.groupId, negate: e.negate }
    );
  }
  var J = { type: le };
  var Ws = { type: V, hard: !0 },
    Gs = { type: V, hard: !0, literal: !0 },
    _ = { type: V },
    x = { type: V, soft: !0 },
    S = [Ws, J],
    Xr = [Gs, J];
...
`),
  ...
  tn.ignoredProperties = Xs;
  var rn = tn;
  var Qs = (t) => t.split(/[/\\]/).pop();
  function nn(t, e) {
    if (!e) return;
  ...
  var R,
    rr = class {
      ...
      hasLeadingWhitespace(e) {
        return z(this, R).has(e.charAt(0));
      }
      hasTrailingWhitespace(e) {
        return z(this, R).has(ke(!1, e, -1));
      }
      trimStart(e) {
        let r = this.getLeadingWhitespaceCount(e);
        return e.slice(r);
...
`,
  ...
  var ni = (t) => v(!1, t, /^[\t\f\r ]*\n/g, ""),
    ...
    cn = (t) => {
      let e = t,
        r = Y.getLeadingWhitespace(e);
      r && (e = e.slice(r.length));
      let n = Y.getTrailingWhitespace(e);
      return (
  ...
  function dt(t, e) {
    return !!(
      ...
      (St(t, e) && !M(t) && t.type !== "interpolation")
    );
  }
  function He(t) {
    return t.type === "attribute" || !t.parent || !t.prev ? !1 : si(t.prev);
  }
  function si(t) {
  ...
  function hn(t) {
    return M(t) || t.type === "interpolation" || sr(t);
  }
  function sr(t) {
        ...
        : !(
            (!t.prev &&
              (t.parent.type === "root" ||
                ...
                M(t.parent) ||
                We(t.parent, e) ||
                !ci(t.parent.cssDisplay))) ||
            (t.prev && !fi(t.prev.cssDisplay))
          );
    }
  }
  function mn(t, e) {
    return Be(t)
      ...
      : !(
          ...
          (t.next && !hi(t.next.cssDisplay))
        );
  }
  function dn(t) {
    return mi(t.cssDisplay) && !M(t);
  }
  function Ve(t) {
    return (
      Be(t) ||
    ...
    return (
      ...
      (t.type === "element" &&
        ...
        (["body", "script", "style"].includes(t.name) ||
          t.children.some((e) => ai(e)))) ||
      (t.firstChild &&
        t.firstChild === t.lastChild &&
        t.firstChild.type !== "text" &&
        Sn(t.firstChild) &&
        (!t.lastChild.isTrailingSpaceSensitive || En(t.lastChild)))
    );
  }
  function ir(t) {
    return (
  ...
  function gt(t) {
    return An(t) || (t.prev && ii(t.prev)) || Cn(t);
  }
  function ii(t) {
    return An(t) || (t.type === "element" && t.fullName === "br") || Cn(t);
  }
  function Cn(t) {
    return Sn(t) && En(t);
  }
  ...
  function Ct(t) {
    return t.lastChild ? Ct(t.lastChild) : t;
  }
  function ai(t) {
    var e;
  ...
  function ui(t, e) {
    ...
    return !i && !s ? "babel" : Le(e, { language: i }) ?? _n(s);
  }
  function oi(t, e) {
    if (!St(t, e)) return;
    let { attrMap: r } = t;
  ...
  function Dn(t, e) {
    ...
    if (t.type === "element" && t.namespace === "svg")
      if (di(t, (s) => s.fullName === "svg:foreignObject")) r = !0;
  ...
  function vn(t) {
    return (
      (t.type === "element" && (!t.namespace || pe(t)) && on[t.name]) || un
    );
  }
  function gi(t) {
...
`)) {
      ...
      let n = Y.getLeadingWhitespaceCount(r);
      if (n === 0) return 0;
      r.length !== n && n < e && (e = n);
    }
    return e === Number.POSITIVE_INFINITY ? 0 : e;
  }
  function ur(t, e = gi(t)) {
    return e === 0
      ? t
      : t
          .split(
...
`);
  ...
  var Ci = new Set(["template", "style", "script"]);
  function We(t, e) {
    return fe(t, e) && !Ci.has(t.fullName);
  }
  function fe(t, e) {
    return (
      e.parser === "vue" &&
  ...
  function wn(t) {
    return (t >= 97 && t <= 102) || (t >= 65 && t <= 70) || Si(t);
  }
  function pr(t) {
    return t === 10 || t === 13;
  }
  ...
  var Ei = /-+([a-z0-9])/g;
  function kn(t) {
    return t.replace(Ei, (...e) => e[1].toUpperCase());
  }
  var ee = class t {
      constructor(e, r, n, s) {
...
` && ++u == r
  ...
  var Ne = class {
    constructor(e, r, n = _t.ERROR) {
      (this.span = e), (this.msg = r), (this.level = n);
    }
    contextualMessage() {
      let e = this.span.start.getContext(100, 3);
      return e
        ? `${this.msg} ("${e.before}[${_t[this.level]} ->]${e.after}")`
        : this.msg;
    }
    toString() {
  ...
  var Ai = [Di, vi, bi, Ti, xi, Li, ki, Bi, Fi, wi];
  function _i(t, e) {
    for (let r of Ai) r(t, e);
    return t;
  }
  function Di(t) {
    t.walk((e) => {
...
`
  ...
  function xi(t) {
    t.walk((e) => {
      ...
      if (
        ...
        (e.children.length === 1 &&
          e.children[0].type === "text" &&
          Y.trim(e.children[0].value).length === 0)
      ) {
  ...
  function Fi(t, e) {
    t.walk((r) => {
      ...
      if (n) {
        if (n.length === 0) {
          r.isDanglingSpaceSensitive = dn(r);
          return;
        }
        for (let s of n)
          (s.isLeadingSpaceSensitive = fn(s, e)),
            (s.isTrailingSpaceSensitive = mn(s, e));
...
` + t
  ...
  async function Ni(t, e) {
    if (t.lang === "yaml") {
      ...
      return jr([t.startDelimiter, S, n, n ? S : "", t.endDelimiter]);
    }
  }
  var Nn = Ni;
  var Ge = () => {};
  ...
  var Pn = Pi;
  function ze(t, e) {
    return [t.isSelfClosing ? "" : Ii(t, e), Ye(t, e)];
  }
  function Ii(t, e) {
    return t.lastChild && Ce(t.lastChild) ? "" : [Ri(t, e), Dt(t, e)];
  }
  function Ye(t, e) {
  ...
  function O(t, e) {
    return Ce(t) ? Dt(t.parent, e) : je(t) ? vt(t.next) : "";
  }
  function Dt(t, e) {
    if ((fr(!t.isSelfClosing), In(t, e))) return "";
    switch (t.type) {
      case "ieConditionalComment":
        return "<!";
      case "element":
  ...
  function In(t, e) {
    return !t.isSelfClosing && !t.endSourceSpan && (He(t) || dt(t.parent, e));
  }
  function W(t) {
    return (
      t.prev &&
  ...
  function Ce(t) {
    return (
      !t.next && !t.hasTrailingSpaces && t.isTrailingSpaceSensitive && N(Ct(t))
    );
  }
  function je(t) {
    return (
  ...
  function Mi(t, e, r) {
    var g;
    let { node: n } = t;
    if (!Pn(n.attrs)) return n.isSelfClosing ? " " : "";
    let s =
        ((g = n.prev) == null ? void 0 : g.type) === "comment" &&
        $i(n.prev.value),
      i =
        typeof s == "boolean"
          ? () => s
          : Array.isArray(s)
          ? (h) => s.includes(h.rawName)
          : () => !1,
      a = t.map(
        ({ node: h }) => (i(h) ? T(e.originalText.slice(te(h), re(h))) : r()),
        "attrs",
      ),
      u =
        n.type === "element" &&
      ...
      c = [U([u ? " " : _, Z(p, a)])];
    return (
      (n.firstChild && Ke(n.firstChild)) ||
      (n.isSelfClosing && ge(n.parent)) ||
      u
        ? c.push(n.isSelfClosing ? " " : "")
        : c.push(
            e.bracketSameLine
              ? n.isSelfClosing
                ? " "
  ...
  function Oi(t) {
    return t.firstChild && Ke(t.firstChild) ? "" : yt(t);
  }
  function Xe(t, e, r) {
    let { node: n } = t;
    return [Qe(n, e), Mi(t, e, r), n.isSelfClosing ? "" : Oi(n)];
  }
  function Qe(t, e) {
    return t.prev && je(t.prev) ? "" : [q(t, e), vt(t)];
  }
  function q(t, e) {
    return Ke(t) ? yt(t.parent) : W(t) ? de(t.prev, e) : "";
  }
  function vt(t) {
    switch (t.type) {
      case "ieConditionalComment":
  ...
  function yt(t) {
    switch ((fr(!t.isSelfClosing), t.type)) {
      case "ieConditionalComment":
        return "]>";
      case "element":
    ...
    return (
      mr.has(r) ||
        mr.set(
          r,
          r.children.some(
            (n) => At(n, e) && ["ts", "typescript"].includes(n.attrMap.lang),
          ),
        ),
      mr.get(r)
    );
  ...
  function Hi(t, e) {
    ...
    t.firstChild && Ke(t.firstChild) && (r -= yt(t).length);
...
` ||
      ...
      for (y = 0; y < n.length; y++)
        (d = n[y]),
          ...
          $n.test(I) && b === "w"
            ...
            : (C = !0);
      if (!C)
        (l.source = { value: r, startOffset: o }),
          E && (l.width = { value: E }),
          A && (l.density = { value: A }),
          F && (l.height = { value: F }),
          c.push(l);
  ...
  function Ki(t) {
    let e = Mn(t),
      r = e.some(({ width: h }) => h),
      n = e.some(({ height: h }) => h),
      s = e.some(({ density: h }) => h);
    if (r + n + s > 1)
      throw new Error("Mixed descriptor in srcset is not supported");
    let i = r ? "width" : n ? "height" : "density",
      a = r ? "w" : n ? "h" : "x",
      u = e.map((h) => h.source.value),
      o = Math.max(...u.map((h) => h.length)),
      p = e.map((h) => (h[i] ? String(h[i].value) : "")),
      c = p.map((h) => {
        let C = h.indexOf(".");
  ...
  async function Vn(t, e, r, n) {
    let s = k(r.node),
      { left: i, operator: a, right: u } = Qi(s),
      o = Pe(r, n);
    return [
      D(
  ...
  function Qi(t) {
    ...
    if (!o.some((p, c) => !p && (c === 0 || o.slice(c + 1).some(Boolean))))
      return {
  ...
  function Ji(t, e) {
    ...
    let { node: r } = t,
      n = r.fullName;
    if (n === "v-for") return Vn;
    if (n === "generic" && At(r.parent, e)) return Un;
    let s = k(r),
      i = Pe(t, e);
    if (yn(r) || bn(r, e)) return (a) => Wn(s, a, { parseWithTs: i });
    if (n.startsWith("@") || n.startsWith("v-on:"))
      return (a) => Zi(s, a, { parseWithTs: i });
    if (n.startsWith(":") || n.startsWith("v-bind:"))
      return (a) => ea(s, a, { parseWithTs: i });
    if (n.startsWith("v-")) return (a) => zn(s, a, { parseWithTs: i });
  }
  function Zi(t, e, { parseWithTs: r }) {
    return Gn(t)
  ...
  async function jn(t, e) {
    let r = [];
    for (let [n, s] of t.split(dr).entries())
      if (n % 2 === 0) r.push(T(s));
      else
        try {
          r.push(
  ...
  function gr({ parser: t }) {
    return (e, r, n) =>
      B(k(n.node), e, { parser: t, trailingComma: "none" }, ne);
  }
  var ta = gr({ parser: "__ng_action" }),
    ra = gr({ parser: "__ng_binding" }),
    na = gr({ parser: "__ng_directive" });
  function sa(t, e) {
    ...
    if (
      ...
      return ra;
    if (n.startsWith("*")) return na;
    let s = k(r);
    if (/^i18n(?:-.+)?$/.test(n))
      return () => Se(ht(Et(r, s.trim())), !s.includes("@@"));
    if (dr.test(s)) return (i) => jn(s, i);
  }
  var Kn = sa;
  function ia(t, e) {
    let { node: r } = t;
        ...
        if (!r.isSelfClosing && St(r, e)) {
          ...
          return n
            ? async (s, i) => {
                ...
                return (
                  u ||
                    ((o = await s(nr(a), { parser: n, __embeddedInHtml: !0 })),
                    (u = o === "")),
                  [
                    q(r, e),
                    D(Xe(t, e, i)),
  ...
  function Je(t, e, r) {
    ...
    return He(n)
      ? [
          ...
          T(
            e.originalText.slice(
              te(n) + (n.prev && je(n.prev) ? vt(n).length : 0),
  ...
  function Tt(t, e, r) {
    ...
    if (ir(n))
      return [
        ...
        ...t.map((i) => {
          let a = i.node,
            u = a.prev ? wt(a.prev, a) : "";
          return [u ? [u, Ve(a.prev) ? S : ""] : "", Je(i, e, r)];
        }, "children"),
      ];
    ...
    return t.map((i, a) => {
      ...
      if (N(u)) {
        if (u.prev && N(u.prev)) {
          let E = wt(u.prev, u);
          if (E) return Ve(u.prev) ? [S, S, Je(i, e, r)] : [E, Je(i, e, r)];
        }
        return Je(i, e, r);
      }
      let o = [],
        ...
        c = [],
        g = [],
        h = u.prev ? wt(u.prev, u) : "",
        C = u.next ? wt(u, u.next) : "";
      return (
        h &&
          (Ve(u.prev)
            ? o.push(S, S)
  ...
  function Jn(t, e, r) {
    let { node: n } = t;
    if (dt(n, e))
      return [q(n, e), D(Xe(t, e, r)), T(bt(n, e)), ...ze(n, e), O(n, e)];
    let s =
        n.children.length === 1 &&
      ...
      a = (c) => D([D(Xe(t, e, r), { id: i }), c, ze(n, e)]),
      u = (c) =>
        s
          ? Kr(c, { groupId: i })
          : (M(n) || We(n, e)) &&
  ...
  var oa = 10;
  for (let t = 0; t <= oa; t++) et();
  function Cr(t) {
    return et(t);
  }
  function la(t, e = "type") {
    Cr(t);
    function r(n) {
      let s = n[e],
        i = t[s];
  ...
  function ha(t, e, r) {
    ...
    switch (n.type) {
      case "front-matter":
        return T(n.raw);
      case "root":
        return e.__onHtmlRoot && e.__onHtmlRoot(n), [D(Tt(t, e, r)), S];
      case "element":
      case "ieConditionalComment":
        return Jn(t, e, r);
      case "ieConditionalStartComment":
      ...
      case "text": {
        ...
        let s = Qr([q(n, e), ...Et(n), O(n, e)]);
        return Array.isArray(s) ? ht(s) : s;
      }
      case "docType":
        return [
          D([
      ...
      case "comment":
        return [q(n, e), T(e.originalText.slice(te(n), re(n))), O(n, e)];
      case "attribute": {
  ...
  var fa = {
    ...
    rs = fa;
  var Rr = {};
  Hr(Rr, { angular: () => au, html: () => iu, lwc: () => ou, vue: () => uu });
  var yc = new RegExp(
    `(\\:not\\()|(([\\.\\#]?)[-\\w]+)|(?:\\[([-.\\w*\\\\$]+)(?:=(["']?)([^\\]"']*)\\5)?\\])|(\\))|(\\s*,\\s*)`,
    "g",
  );
  ...
  var Sr = { name: "custom-elements" },
    Er = { name: "no-errors-schema" };
  var j;
  (function (t) {
    (t[(t.NONE = 0)] = "NONE"),
      (t[(t.HTML = 1)] = "HTML"),
  ...
  function Ar(t) {
    return tt(t)[1] === "ng-container";
  }
  function _r(t) {
    return tt(t)[1] === "ng-content";
  }
  function Ie(t) {
    return t === null ? null : tt(t)[0];
  }
  function Re(t, e) {
    return t ? `:${t}:${e}` : e;
  }
  ...
  function Dr() {
    return (
      kt ||
        ((kt = {}),
        xt(j.HTML, ["iframe|srcdoc", "*|innerHTML", "*|outerHTML"]),
        xt(j.STYLE, ["*|style"]),
        xt(j.URL, [
          "*|formAction",
          "area|href",
  ...
  function xt(t, e) {
    for (let r of e) kt[r.toLowerCase()] = t;
  }
  var Bt = class {};
  var ma = "boolean",
    da = "number",
    ...
    Ea = Array.from(as).reduce((t, [e, r]) => (t.set(e, r), t), new Map()),
    Lt = class extends Bt {
      constructor() {
        super(),
          ...
          Sa.forEach((e) => {
            let r = new Map(),
              ...
              [u, o] = s.split("^");
            u.split(",").forEach((c) => {
              this._schema.set(c.toLowerCase(), r),
                this._eventSchema.set(c.toLowerCase(), n);
            });
            let p = o && this._schema.get(o.toLowerCase());
            if (p) {
              for (let [c, g] of p) r.set(c, g);
              for (let c of this._eventSchema.get(o.toLowerCase())) n.add(c);
            }
            a.forEach((c) => {
              if (c.length > 0)
                switch (c[0]) {
                  case "*":
                    ...
                    break;
                  case "!":
                    r.set(c.substring(1), ma);
                    break;
                  case "#":
                    r.set(c.substring(1), da);
                    break;
                  case "%":
                    r.set(c.substring(1), Ca);
                    break;
                  default:
                    r.set(c, ga);
                }
      ...
      hasProperty(e, r, n) {
        if (n.some((i) => i.name === Er.name)) return !0;
        if (e.indexOf("-") > -1) {
          if (Ar(e) || _r(e)) return !1;
      ...
      hasElement(e, r) {
        return r.some((n) => n.name === Er.name) ||
          (e.indexOf("-") > -1 &&
            (Ar(e) || _r(e) || r.some((n) => n.name === Sr.name)))
          ? !0
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`,
      ...
      allKnownAttributesOfElement(e) {
        let r =
          this._schema.get(e.toLowerCase()) || this._schema.get("unknown");
        return Array.from(r.keys()).map((n) => Ea.get(n) ?? n);
      }
    ...
    return (
      rt ||
        ...
        (rt = {
          ...
          style: new f({ contentType: L.RAW_TEXT }),
          script: new f({ contentType: L.RAW_TEXT }),
          title: new f({
            contentType: {
        ...
        new Lt().allKnownElementNames().forEach((e) => {
          !rt.hasOwnProperty(e) &&
            Ie(e) === null &&
            (rt[e] = new f({ canSelfClose: !1 }));
        })),
      rt[t] ?? us
    );
  }
...
`,
  ...
  var vr = class t {
      static fromArray(e) {
        return e ? (os("interpolation", e), new t(e[0], e[1])) : yr;
      }
      constructor(e, r) {
  ...
  function Es(t, e, r, n = {}) {
    let s = new xr(new me(t, e), r, n);
    return (
      s.tokenize(),
      new Tr(ja(s.tokens), s.errors, s.nonNormalizedIcuExpressions)
    );
  }
  var Ha = /\r\n?/g;
  function Oe(t) {
    ...
    xr = class {
      constructor(e, r, n) {
        (this._getTagContentType = r),
          ...
          (this._interpolationConfig = n.interpolationConfig || yr),
        ...
        (this._cursor = n.escapedString ? new kr(e, s) : new Gt(e, s)),
...
`,
      ...
      _tokenizeExpansionForm() {
        ...
        if (za(this._cursor.peek()) && this._isInExpansionForm())
      ...
      _createError(e, r) {
        ...
        let n = new at(e, this._currentTokenType, r);
        return (
          (this._currentTokenStart = null),
          (this._currentTokenType = null),
          new ut(n)
      ...
      _consumeEntity(e) {
        ...
        if ((this._cursor.advance(), this._attemptCharCode(35))) {
          ...
          if ((this._attemptCharCodeUntilFn(Wa), this._cursor.peek() != 59)) {
            this._cursor.advance();
            let a = n ? Wt.HEX : Wt.DEC;
            throw this._createError(
              Va(a, this._cursor.getChars(r)),
      ...
      _consumePrefixAndName() {
        let e = this._cursor.clone(),
          r = "";
        for (; this._cursor.peek() !== 58 && !Ua(this._cursor.peek()); )
          this._cursor.advance();
        let n;
      ...
      _consumeTagOpen(e) {
        ...
        try {
          ...
          for (
            ...
            if ((this._attemptCharCodeUntilFn(P), this._attemptCharCode(61))) {
              this._attemptCharCodeUntilFn(P);
      ...
      _consumeRawTextWithTagClose(e, r, n) {
        this._consumeRawText(n, () =>
          ...
          !this._attemptStrCaseInsensitive(e ? `${e}:${r}` : r))
            ? !1
            : (this._attemptCharCodeUntilFn(P), this._attemptCharCode(62)),
        ),
          this._beginToken(3),
  ...
  function Wa(t) {
    return t === 59 || t === 0 || !wn(t);
  }
  function Ga(t) {
    return t === 59 || t === 0 || !cr(t);
  }
  function za(t) {
    return t !== 125;
  }
  ...
  var Gt = class t {
      ...
      advanceState(e) {
        if (e.offset >= this.end)
          throw ((this.state = e), new ot('Unexpected character "EOF"', this));
        let r = this.charAt(e.offset);
        r === 10 ? (e.line++, (e.column = 0)) : pr(r) || e.column++,
          e.offset++,
          this.updatePeek(e);
      }
      updatePeek(e) {
      ...
      decodeHexDigits(e, r) {
        ...
        if (isNaN(s))
          throw (
            ...
            new ot("Invalid hexadecimal escape sequence", e))
          );
        return s;
      }
    },
    ...
    zt = class {
      ...
      parse(e, r, n, s = !1, i) {
        let a =
          ...
          E = new Nr(g.tokens, u, h, C, s);
        return E.build(), new Fr(E.rootNodes, g.errors.concat(E.errors));
      }
    },
    Nr = class t {
      constructor(e, r, n, s, i) {
      ...
      _consumeCdata(e) {
        ...
        this._addToParent(
          new Nt(n, new m(e.sourceSpan.start, (s || r).sourceSpan.end), [r]),
        );
      }
      _consumeComment(e) {
      ...
      _parseExpansionCase() {
        ...
        return new It(e.parts[0], i.rootNodes, a, e.sourceSpan, u);
      }
...
`
        ...
        if (s.length > 0) {
          let i = e.sourceSpan;
          this._addToParent(
            new Ft(s, new m(n.start, i.end, n.fullStart, n.details), r),
          );
        }
      }
      _closeVoidElement() {
      ...
      _consumeStartTag(e) {
        ...
        let u = this._peek.sourceSpan.fullStart,
          ...
          c = new m(e.sourceSpan.start.moveBy(1), e.sourceSpan.end),
          g = new $t(i, s, [], o, p, void 0, c);
        this._pushElement(g),
          a
      ...
      _consumeAttr(e) {
        ...
        if (this._peek.type === 16)
          for (
            ...
            a.push(g),
              g.type === 17
                ? (i += g.parts.join("").replace(/&([^;]+);/g, _s))
                : g.type === 9
                ? (i += g.parts[0])
                : (i += g.parts.join("")),
              (o = n = g.sourceSpan.end);
          }
  ...
  var Kt = { attrs: !0, children: !0 },
    bs = new Set(["parent"]),
    Xt = class t {
      constructor(e = {}) {
        for (let r of new Set([...bs, ...Object.keys(e)]))
          this.setProperty(r, e[r]);
      }
      setProperty(e, r) {
        if (this[e] !== r) {
          if (
            (e in Kt && (r = r.map((n) => this.createChild(n))), !bs.has(e))
          ) {
            this[e] = r;
            return;
          }
      ...
      map(e) {
        ...
        for (let n in Kt) {
          let s = this[n];
          if (s) {
            let i = Za(s, (a) => a.map(e));
            r !== s &&
              (r || (r = new t({ parent: this.parent })), r.setProperty(n, i));
          }
        }
        if (r) for (let n in this) n in Kt || (r[n] = this[n]);
        return e(r || this);
      }
      walk(e) {
        for (let r in Kt) {
  ...
  var eu = [
    { regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: tu },
    { regex: /^\[if([^\]]*)]><!$/, parse: ru },
    { regex: /^<!\s*\[endif]$/, parse: nu },
  ];
  function ws(t, e) {
    if (t.value)
      for (let { regex: r, parse: n } of eu) {
  ...
  function xs(t, e, r) {
    ...
    if (n === "vue") {
      if (
        c.some(
          (w) =>
            (w.type === "docType" && w.value === "html") ||
            (w.type === "element" && w.name.toLowerCase() === "html"),
        )
      )
        return xs(t, Bs, r);
      let d,
        ...
        I = (w) =>
          b().rootNodes.find(
            ({ startSourceSpan: $ }) =>
              $ && $.start.offset === w.startSourceSpan.start.offset,
          ) ?? w;
      for (let [w, $] of c.entries()) {
        let { endSourceSpan: Mr, startSourceSpan: Ps } = $;
        if (Mr === null) (g = b().errors), (c[w] = I($));
        else if (su($, r)) {
          let Or = b().errors.find(
            (qr) =>
              qr.span.start.offset > Ps.start.offset &&
              qr.span.start.offset < Mr.end.offset,
          );
          Or && Ts(Or), (c[w] = I($));
        }
      }
    ...
    g.length > 0 && Ts(g[0]);
    let h = (l) => {
        let d = l.name.startsWith(":") ? l.name.slice(1).split(":")[0] : null,
          b = l.nameSpan.toString(),
          I = d !== null && b.startsWith(`${d}:`),
          w = I ? b.slice(d.length + 1) : b;
        (l.name = w), (l.namespace = d), (l.hasExplicitNamespace = I);
      },
      C = (l) => {
        switch (l.type) {
          case "element":
            h(l);
            for (let d of l.attrs)
              h(d),
                d.valueSpan
            ...
            break;
          case "comment":
            l.value = l.sourceSpan.toString().slice(4, -3);
            break;
          case "text":
            l.value = l.sourceSpan.toString();
            break;
        }
      },
      E = (l, d) => {
      ...
      A = (l) => {
        if (
          ...
          (i &&
            (!l.namespace ||
              l.namespace === l.tagDefinition.implicitNamespacePrefix ||
              pe(l)) &&
            (l.name = E(l.name, (d) => ys.has(d))),
          a)
        )
          for (let d of l.attrs)
            d.namespace ||
              (d.name = E(
                ...
                (b) =>
                  jt.has(l.name) &&
                  (jt.get("*").has(b) || jt.get(l.name).has(b)),
              ));
      },
      F = (l) => {
        l.sourceSpan &&
          l.endSourceSpan &&
          (l.sourceSpan = new m(l.sourceSpan.start, l.endSourceSpan.end));
      },
      y = (l) => {
        if (l.type === "element") {
          let d = $e(o ? l.name : l.name.toLowerCase());
          !l.namespace || l.namespace === d.implicitNamespacePrefix || pe(l)
            ? (l.tagDefinition = d)
            : (l.tagDefinition = $e(""));
        }
      };
  ...
  function ks(t, e, r = {}, n = !0) {
    let { frontMatter: s, content: i } = n
      ...
      u = new ee(a, 0, 0, 0),
      o = u.moveBy(t.length),
      p = { type: "root", sourceSpan: new m(u, o), children: xs(i, e, r) };
    if (s) {
      let h = new ee(a, 0, 0, 0),
        C = h.moveBy(s.raw.length);
      (s.sourceSpan = new m(h, C)), p.children.unshift(s);
    }
    let c = new Xt(p),
      g = (h, C) => {
        let { offset: E } = C,
          A = v(!1, t.slice(0, E), /[^\n\r]/g, " "),
          y = ks(A + h, e, r, !1);
        y.sourceSpan = new m(C, ke(!1, y.children, -1).sourceSpan.end);
        let l = y.children[0];
        return (
          l.length === E
            ? y.children.shift()
            : ((l.sourceSpan = new m(
                l.sourceSpan.start.moveBy(E),
                l.sourceSpan.end,
              )),
              (l.value = l.value.slice(E))),
          y
        );
      };
    return (
